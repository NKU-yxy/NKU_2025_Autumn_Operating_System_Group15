...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	547030ef          	jal	ra,ffffffffc0203da8 <memset>
    dtb_init();
...
ffffffffc0200072:	d8a58593          	addi	a1,a1,-630 # ffffffffc0203df8 <etext+0x2>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	da250513          	addi	a0,a0,-606 # ffffffffc0203e18 <etext+0x22>
...
ffffffffc0200096:	504030ef          	jal	ra,ffffffffc020359a <proc_init>
...
ffffffffc02000a2:	746030ef          	jal	ra,ffffffffc02037e8 <cpu_idle>
...
ffffffffc02000c0:	d6450513          	addi	a0,a0,-668 # ffffffffc0203e20 <etext+0x2a>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	7fc030ef          	jal	ra,ffffffffc0203984 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	7c6030ef          	jal	ra,ffffffffc0203984 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	c4a50513          	addi	a0,a0,-950 # ffffffffc0203e28 <etext+0x32>
{
...
ffffffffc02001f8:	c5450513          	addi	a0,a0,-940 # ffffffffc0203e48 <etext+0x52>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	bf658593          	addi	a1,a1,-1034 # ffffffffc0203df6 <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	c6050513          	addi	a0,a0,-928 # ffffffffc0203e68 <etext+0x72>
...
ffffffffc0200220:	c6c50513          	addi	a0,a0,-916 # ffffffffc0203e88 <etext+0x92>
...
ffffffffc0200234:	c7850513          	addi	a0,a0,-904 # ffffffffc0203ea8 <etext+0xb2>
...
ffffffffc0200262:	c6a50513          	addi	a0,a0,-918 # ffffffffc0203ec8 <etext+0xd2>
}
...
ffffffffc0200270:	c8c60613          	addi	a2,a2,-884 # ffffffffc0203ef8 <etext+0x102>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	c9850513          	addi	a0,a0,-872 # ffffffffc0203f10 <etext+0x11a>
{
...
ffffffffc020028c:	ca060613          	addi	a2,a2,-864 # ffffffffc0203f28 <etext+0x132>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	cb858593          	addi	a1,a1,-840 # ffffffffc0203f48 <etext+0x152>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	cb850513          	addi	a0,a0,-840 # ffffffffc0203f50 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	cba60613          	addi	a2,a2,-838 # ffffffffc0203f60 <etext+0x16a>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	cda58593          	addi	a1,a1,-806 # ffffffffc0203f88 <etext+0x192>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	c9a50513          	addi	a0,a0,-870 # ffffffffc0203f50 <etext+0x15a>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	cd660613          	addi	a2,a2,-810 # ffffffffc0203f98 <etext+0x1a2>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	cee58593          	addi	a1,a1,-786 # ffffffffc0203fb8 <etext+0x1c2>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	c7e50513          	addi	a0,a0,-898 # ffffffffc0203f50 <etext+0x15a>
...
ffffffffc0200310:	cbc50513          	addi	a0,a0,-836 # ffffffffc0203fc8 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	cc250513          	addi	a0,a0,-830 # ffffffffc0203ff0 <etext+0x1fa>
...
ffffffffc0200354:	d10c0c13          	addi	s8,s8,-752 # ffffffffc0204060 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200358:	00004917          	auipc	s2,0x4
ffffffffc020035c:	cc090913          	addi	s2,s2,-832 # ffffffffc0204018 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	cc048493          	addi	s1,s1,-832 # ffffffffc0204020 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	cbeb0b13          	addi	s6,s6,-834 # ffffffffc0204028 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	bd6a0a13          	addi	s4,s4,-1066 # ffffffffc0203f48 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200398:	cccd0d13          	addi	s10,s10,-820 # ffffffffc0204060 <commands>
        argv[argc ++] = buf;
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	1ad030ef          	jal	ra,ffffffffc0203d4e <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	199030ef          	jal	ra,ffffffffc0203d4e <strcmp>
...
ffffffffc02003f4:	19f030ef          	jal	ra,ffffffffc0203d92 <strchr>
...
ffffffffc0200432:	161030ef          	jal	ra,ffffffffc0203d92 <strchr>
...
ffffffffc0200450:	bfc50513          	addi	a0,a0,-1028 # ffffffffc0204048 <etext+0x252>
...
ffffffffc020048c:	c2050513          	addi	a0,a0,-992 # ffffffffc02040a8 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02004a2:	caa50513          	addi	a0,a0,-854 # ffffffffc0205148 <default_pmm_manager+0x530>
...
ffffffffc02004e0:	bec50513          	addi	a0,a0,-1044 # ffffffffc02040c8 <commands+0x68>
    ticks = 0;
...
ffffffffc0200566:	b8650513          	addi	a0,a0,-1146 # ffffffffc02040e8 <commands+0x88>
void dtb_init(void) {
...
ffffffffc0200594:	b6850513          	addi	a0,a0,-1176 # ffffffffc02040f8 <commands+0x98>
...
ffffffffc02005aa:	b6250513          	addi	a0,a0,-1182 # ffffffffc0204108 <commands+0xa8>
...
ffffffffc02005ba:	b6a50513          	addi	a0,a0,-1174 # ffffffffc0204120 <commands+0xc0>
    if (boot_dtb == 0) {
...
ffffffffc0200674:	b0090913          	addi	s2,s2,-1280 # ffffffffc0204170 <commands+0x110>
...
ffffffffc0200682:	aea48493          	addi	s1,s1,-1302 # ffffffffc0204168 <commands+0x108>
...
ffffffffc02006d6:	b1650513          	addi	a0,a0,-1258 # ffffffffc02041e8 <commands+0x188>
ffffffffc02006da:	abbff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    }
    cprintf("DTB init completed\n");
ffffffffc02006de:	00004517          	auipc	a0,0x4
ffffffffc02006e2:	b4250513          	addi	a0,a0,-1214 # ffffffffc0204220 <commands+0x1c0>
}
...
ffffffffc0200722:	a2250513          	addi	a0,a0,-1502 # ffffffffc0204140 <commands+0xe0>
}
...
ffffffffc020072c:	5da030ef          	jal	ra,ffffffffc0203d06 <strlen>
...
ffffffffc0200738:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc020073a:	632030ef          	jal	ra,ffffffffc0203d6c <strncmp>
...
ffffffffc02007d0:	57e030ef          	jal	ra,ffffffffc0203d4e <strcmp>
...
ffffffffc02007e8:	99450513          	addi	a0,a0,-1644 # ffffffffc0204178 <commands+0x118>
           fdt32_to_cpu(x >> 32);
...
ffffffffc02008b6:	8e650513          	addi	a0,a0,-1818 # ffffffffc0204198 <commands+0x138>
...
ffffffffc02008c8:	8ec50513          	addi	a0,a0,-1812 # ffffffffc02041b0 <commands+0x150>
...
ffffffffc02008da:	8fa50513          	addi	a0,a0,-1798 # ffffffffc02041d0 <commands+0x170>
ffffffffc02008de:	8b7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("DTB init completed\n");
ffffffffc02008e2:	00004517          	auipc	a0,0x4
ffffffffc02008e6:	93e50513          	addi	a0,a0,-1730 # ffffffffc0204220 <commands+0x1c0>
        memory_base = mem_base;
...
ffffffffc0200944:	8f850513          	addi	a0,a0,-1800 # ffffffffc0204238 <commands+0x1d8>
{
...
ffffffffc0200954:	90050513          	addi	a0,a0,-1792 # ffffffffc0204250 <commands+0x1f0>
...
ffffffffc0200962:	90a50513          	addi	a0,a0,-1782 # ffffffffc0204268 <commands+0x208>
...
ffffffffc0200970:	91450513          	addi	a0,a0,-1772 # ffffffffc0204280 <commands+0x220>
...
ffffffffc020097e:	91e50513          	addi	a0,a0,-1762 # ffffffffc0204298 <commands+0x238>
...
ffffffffc020098c:	92850513          	addi	a0,a0,-1752 # ffffffffc02042b0 <commands+0x250>
...
ffffffffc020099a:	93250513          	addi	a0,a0,-1742 # ffffffffc02042c8 <commands+0x268>
...
ffffffffc02009a8:	93c50513          	addi	a0,a0,-1732 # ffffffffc02042e0 <commands+0x280>
...
ffffffffc02009b6:	94650513          	addi	a0,a0,-1722 # ffffffffc02042f8 <commands+0x298>
...
ffffffffc02009c4:	95050513          	addi	a0,a0,-1712 # ffffffffc0204310 <commands+0x2b0>
...
ffffffffc02009d2:	95a50513          	addi	a0,a0,-1702 # ffffffffc0204328 <commands+0x2c8>
...
ffffffffc02009e0:	96450513          	addi	a0,a0,-1692 # ffffffffc0204340 <commands+0x2e0>
...
ffffffffc02009ee:	96e50513          	addi	a0,a0,-1682 # ffffffffc0204358 <commands+0x2f8>
...
ffffffffc02009fc:	97850513          	addi	a0,a0,-1672 # ffffffffc0204370 <commands+0x310>
...
ffffffffc0200a0a:	98250513          	addi	a0,a0,-1662 # ffffffffc0204388 <commands+0x328>
...
ffffffffc0200a18:	98c50513          	addi	a0,a0,-1652 # ffffffffc02043a0 <commands+0x340>
...
ffffffffc0200a26:	99650513          	addi	a0,a0,-1642 # ffffffffc02043b8 <commands+0x358>
...
ffffffffc0200a34:	9a050513          	addi	a0,a0,-1632 # ffffffffc02043d0 <commands+0x370>
...
ffffffffc0200a42:	9aa50513          	addi	a0,a0,-1622 # ffffffffc02043e8 <commands+0x388>
...
ffffffffc0200a50:	9b450513          	addi	a0,a0,-1612 # ffffffffc0204400 <commands+0x3a0>
...
ffffffffc0200a5e:	9be50513          	addi	a0,a0,-1602 # ffffffffc0204418 <commands+0x3b8>
...
ffffffffc0200a6c:	9c850513          	addi	a0,a0,-1592 # ffffffffc0204430 <commands+0x3d0>
...
ffffffffc0200a7a:	9d250513          	addi	a0,a0,-1582 # ffffffffc0204448 <commands+0x3e8>
...
ffffffffc0200a88:	9dc50513          	addi	a0,a0,-1572 # ffffffffc0204460 <commands+0x400>
...
ffffffffc0200a96:	9e650513          	addi	a0,a0,-1562 # ffffffffc0204478 <commands+0x418>
...
ffffffffc0200aa4:	9f050513          	addi	a0,a0,-1552 # ffffffffc0204490 <commands+0x430>
...
ffffffffc0200ab2:	9fa50513          	addi	a0,a0,-1542 # ffffffffc02044a8 <commands+0x448>
...
ffffffffc0200ac0:	a0450513          	addi	a0,a0,-1532 # ffffffffc02044c0 <commands+0x460>
...
ffffffffc0200ace:	a0e50513          	addi	a0,a0,-1522 # ffffffffc02044d8 <commands+0x478>
...
ffffffffc0200adc:	a1850513          	addi	a0,a0,-1512 # ffffffffc02044f0 <commands+0x490>
...
ffffffffc0200aea:	a2250513          	addi	a0,a0,-1502 # ffffffffc0204508 <commands+0x4a8>
...
ffffffffc0200afc:	a2850513          	addi	a0,a0,-1496 # ffffffffc0204520 <commands+0x4c0>
}
...
ffffffffc0200b12:	a2a50513          	addi	a0,a0,-1494 # ffffffffc0204538 <commands+0x4d8>
{
...
ffffffffc0200b2a:	a2a50513          	addi	a0,a0,-1494 # ffffffffc0204550 <commands+0x4f0>
...
ffffffffc0200b3a:	a3250513          	addi	a0,a0,-1486 # ffffffffc0204568 <commands+0x508>
...
ffffffffc0200b4a:	a3a50513          	addi	a0,a0,-1478 # ffffffffc0204580 <commands+0x520>
...
ffffffffc0200b5e:	a3e50513          	addi	a0,a0,-1474 # ffffffffc0204598 <commands+0x538>
}
...
ffffffffc0200b7a:	ada70713          	addi	a4,a4,-1318 # ffffffffc0204650 <commands+0x5f0>
...
ffffffffc0200b8c:	a8850513          	addi	a0,a0,-1400 # ffffffffc0204610 <commands+0x5b0>
ffffffffc0200b90:	e04ff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("Hypervisor software interrupt\n");
ffffffffc0200b94:	00004517          	auipc	a0,0x4
ffffffffc0200b98:	a5c50513          	addi	a0,a0,-1444 # ffffffffc02045f0 <commands+0x590>
ffffffffc0200b9c:	df8ff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("User software interrupt\n");
ffffffffc0200ba0:	00004517          	auipc	a0,0x4
ffffffffc0200ba4:	a1050513          	addi	a0,a0,-1520 # ffffffffc02045b0 <commands+0x550>
ffffffffc0200ba8:	decff06f          	j	ffffffffc0200194 <cprintf>
        cprintf("Supervisor software interrupt\n");
ffffffffc0200bac:	00004517          	auipc	a0,0x4
ffffffffc0200bb0:	a2450513          	addi	a0,a0,-1500 # ffffffffc02045d0 <commands+0x570>
...
ffffffffc0200bbe:	a7650513          	addi	a0,a0,-1418 # ffffffffc0204630 <commands+0x5d0>
...
ffffffffc0200bd6:	c4670713          	addi	a4,a4,-954 # ffffffffc0204818 <commands+0x7b8>
...
ffffffffc0200e1e:	abe63603          	ld	a2,-1346(a2) # ffffffffc02058d8 <nbase>
...
ffffffffc020105e:	b38d                	j	ffffffffc0200dc0 <default_check+0x42>
        assert(PageProperty(p));
ffffffffc0201060:	00003697          	auipc	a3,0x3
ffffffffc0201064:	7f868693          	addi	a3,a3,2040 # ffffffffc0204858 <commands+0x7f8>
ffffffffc0201068:	00004617          	auipc	a2,0x4
ffffffffc020106c:	80060613          	addi	a2,a2,-2048 # ffffffffc0204868 <commands+0x808>
ffffffffc0201070:	0f000593          	li	a1,240
ffffffffc0201074:	00004517          	auipc	a0,0x4
ffffffffc0201078:	80c50513          	addi	a0,a0,-2036 # ffffffffc0204880 <commands+0x820>
ffffffffc020107c:	bdeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201080:	00004697          	auipc	a3,0x4
ffffffffc0201084:	89868693          	addi	a3,a3,-1896 # ffffffffc0204918 <commands+0x8b8>
ffffffffc0201088:	00003617          	auipc	a2,0x3
ffffffffc020108c:	7e060613          	addi	a2,a2,2016 # ffffffffc0204868 <commands+0x808>
ffffffffc0201090:	0bd00593          	li	a1,189
ffffffffc0201094:	00003517          	auipc	a0,0x3
ffffffffc0201098:	7ec50513          	addi	a0,a0,2028 # ffffffffc0204880 <commands+0x820>
ffffffffc020109c:	bbeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc02010a0:	00004697          	auipc	a3,0x4
ffffffffc02010a4:	8a068693          	addi	a3,a3,-1888 # ffffffffc0204940 <commands+0x8e0>
ffffffffc02010a8:	00003617          	auipc	a2,0x3
ffffffffc02010ac:	7c060613          	addi	a2,a2,1984 # ffffffffc0204868 <commands+0x808>
ffffffffc02010b0:	0be00593          	li	a1,190
ffffffffc02010b4:	00003517          	auipc	a0,0x3
ffffffffc02010b8:	7cc50513          	addi	a0,a0,1996 # ffffffffc0204880 <commands+0x820>
ffffffffc02010bc:	b9eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc02010c0:	00004697          	auipc	a3,0x4
ffffffffc02010c4:	8c068693          	addi	a3,a3,-1856 # ffffffffc0204980 <commands+0x920>
ffffffffc02010c8:	00003617          	auipc	a2,0x3
ffffffffc02010cc:	7a060613          	addi	a2,a2,1952 # ffffffffc0204868 <commands+0x808>
ffffffffc02010d0:	0c000593          	li	a1,192
ffffffffc02010d4:	00003517          	auipc	a0,0x3
ffffffffc02010d8:	7ac50513          	addi	a0,a0,1964 # ffffffffc0204880 <commands+0x820>
ffffffffc02010dc:	b7eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!list_empty(&free_list));
ffffffffc02010e0:	00004697          	auipc	a3,0x4
ffffffffc02010e4:	92868693          	addi	a3,a3,-1752 # ffffffffc0204a08 <commands+0x9a8>
ffffffffc02010e8:	00003617          	auipc	a2,0x3
ffffffffc02010ec:	78060613          	addi	a2,a2,1920 # ffffffffc0204868 <commands+0x808>
ffffffffc02010f0:	0d900593          	li	a1,217
ffffffffc02010f4:	00003517          	auipc	a0,0x3
ffffffffc02010f8:	78c50513          	addi	a0,a0,1932 # ffffffffc0204880 <commands+0x820>
ffffffffc02010fc:	b5eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201100:	00003697          	auipc	a3,0x3
ffffffffc0201104:	7b868693          	addi	a3,a3,1976 # ffffffffc02048b8 <commands+0x858>
ffffffffc0201108:	00003617          	auipc	a2,0x3
ffffffffc020110c:	76060613          	addi	a2,a2,1888 # ffffffffc0204868 <commands+0x808>
ffffffffc0201110:	0d200593          	li	a1,210
ffffffffc0201114:	00003517          	auipc	a0,0x3
ffffffffc0201118:	76c50513          	addi	a0,a0,1900 # ffffffffc0204880 <commands+0x820>
ffffffffc020111c:	b3eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 3);
ffffffffc0201120:	00004697          	auipc	a3,0x4
ffffffffc0201124:	8d868693          	addi	a3,a3,-1832 # ffffffffc02049f8 <commands+0x998>
ffffffffc0201128:	00003617          	auipc	a2,0x3
ffffffffc020112c:	74060613          	addi	a2,a2,1856 # ffffffffc0204868 <commands+0x808>
ffffffffc0201130:	0d000593          	li	a1,208
ffffffffc0201134:	00003517          	auipc	a0,0x3
ffffffffc0201138:	74c50513          	addi	a0,a0,1868 # ffffffffc0204880 <commands+0x820>
ffffffffc020113c:	b1eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201140:	00004697          	auipc	a3,0x4
ffffffffc0201144:	8a068693          	addi	a3,a3,-1888 # ffffffffc02049e0 <commands+0x980>
ffffffffc0201148:	00003617          	auipc	a2,0x3
ffffffffc020114c:	72060613          	addi	a2,a2,1824 # ffffffffc0204868 <commands+0x808>
ffffffffc0201150:	0cb00593          	li	a1,203
ffffffffc0201154:	00003517          	auipc	a0,0x3
ffffffffc0201158:	72c50513          	addi	a0,a0,1836 # ffffffffc0204880 <commands+0x820>
ffffffffc020115c:	afeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0201160:	00004697          	auipc	a3,0x4
ffffffffc0201164:	86068693          	addi	a3,a3,-1952 # ffffffffc02049c0 <commands+0x960>
ffffffffc0201168:	00003617          	auipc	a2,0x3
ffffffffc020116c:	70060613          	addi	a2,a2,1792 # ffffffffc0204868 <commands+0x808>
ffffffffc0201170:	0c200593          	li	a1,194
ffffffffc0201174:	00003517          	auipc	a0,0x3
ffffffffc0201178:	70c50513          	addi	a0,a0,1804 # ffffffffc0204880 <commands+0x820>
ffffffffc020117c:	adeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != NULL);
ffffffffc0201180:	00004697          	auipc	a3,0x4
ffffffffc0201184:	8d068693          	addi	a3,a3,-1840 # ffffffffc0204a50 <commands+0x9f0>
ffffffffc0201188:	00003617          	auipc	a2,0x3
ffffffffc020118c:	6e060613          	addi	a2,a2,1760 # ffffffffc0204868 <commands+0x808>
ffffffffc0201190:	0f800593          	li	a1,248
ffffffffc0201194:	00003517          	auipc	a0,0x3
ffffffffc0201198:	6ec50513          	addi	a0,a0,1772 # ffffffffc0204880 <commands+0x820>
ffffffffc020119c:	abeff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc02011a0:	00004697          	auipc	a3,0x4
ffffffffc02011a4:	8a068693          	addi	a3,a3,-1888 # ffffffffc0204a40 <commands+0x9e0>
ffffffffc02011a8:	00003617          	auipc	a2,0x3
ffffffffc02011ac:	6c060613          	addi	a2,a2,1728 # ffffffffc0204868 <commands+0x808>
ffffffffc02011b0:	0df00593          	li	a1,223
ffffffffc02011b4:	00003517          	auipc	a0,0x3
ffffffffc02011b8:	6cc50513          	addi	a0,a0,1740 # ffffffffc0204880 <commands+0x820>
ffffffffc02011bc:	a9eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011c0:	00004697          	auipc	a3,0x4
ffffffffc02011c4:	82068693          	addi	a3,a3,-2016 # ffffffffc02049e0 <commands+0x980>
ffffffffc02011c8:	00003617          	auipc	a2,0x3
ffffffffc02011cc:	6a060613          	addi	a2,a2,1696 # ffffffffc0204868 <commands+0x808>
ffffffffc02011d0:	0dd00593          	li	a1,221
ffffffffc02011d4:	00003517          	auipc	a0,0x3
ffffffffc02011d8:	6ac50513          	addi	a0,a0,1708 # ffffffffc0204880 <commands+0x820>
ffffffffc02011dc:	a7eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc02011e0:	00004697          	auipc	a3,0x4
ffffffffc02011e4:	84068693          	addi	a3,a3,-1984 # ffffffffc0204a20 <commands+0x9c0>
ffffffffc02011e8:	00003617          	auipc	a2,0x3
ffffffffc02011ec:	68060613          	addi	a2,a2,1664 # ffffffffc0204868 <commands+0x808>
ffffffffc02011f0:	0dc00593          	li	a1,220
ffffffffc02011f4:	00003517          	auipc	a0,0x3
ffffffffc02011f8:	68c50513          	addi	a0,a0,1676 # ffffffffc0204880 <commands+0x820>
ffffffffc02011fc:	a5eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201200:	00003697          	auipc	a3,0x3
ffffffffc0201204:	6b868693          	addi	a3,a3,1720 # ffffffffc02048b8 <commands+0x858>
ffffffffc0201208:	00003617          	auipc	a2,0x3
ffffffffc020120c:	66060613          	addi	a2,a2,1632 # ffffffffc0204868 <commands+0x808>
ffffffffc0201210:	0b900593          	li	a1,185
ffffffffc0201214:	00003517          	auipc	a0,0x3
ffffffffc0201218:	66c50513          	addi	a0,a0,1644 # ffffffffc0204880 <commands+0x820>
ffffffffc020121c:	a3eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201220:	00003697          	auipc	a3,0x3
ffffffffc0201224:	7c068693          	addi	a3,a3,1984 # ffffffffc02049e0 <commands+0x980>
ffffffffc0201228:	00003617          	auipc	a2,0x3
ffffffffc020122c:	64060613          	addi	a2,a2,1600 # ffffffffc0204868 <commands+0x808>
ffffffffc0201230:	0d600593          	li	a1,214
ffffffffc0201234:	00003517          	auipc	a0,0x3
ffffffffc0201238:	64c50513          	addi	a0,a0,1612 # ffffffffc0204880 <commands+0x820>
ffffffffc020123c:	a1eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201240:	00003697          	auipc	a3,0x3
ffffffffc0201244:	6b868693          	addi	a3,a3,1720 # ffffffffc02048f8 <commands+0x898>
ffffffffc0201248:	00003617          	auipc	a2,0x3
ffffffffc020124c:	62060613          	addi	a2,a2,1568 # ffffffffc0204868 <commands+0x808>
ffffffffc0201250:	0d400593          	li	a1,212
ffffffffc0201254:	00003517          	auipc	a0,0x3
ffffffffc0201258:	62c50513          	addi	a0,a0,1580 # ffffffffc0204880 <commands+0x820>
ffffffffc020125c:	9feff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201260:	00003697          	auipc	a3,0x3
ffffffffc0201264:	67868693          	addi	a3,a3,1656 # ffffffffc02048d8 <commands+0x878>
ffffffffc0201268:	00003617          	auipc	a2,0x3
ffffffffc020126c:	60060613          	addi	a2,a2,1536 # ffffffffc0204868 <commands+0x808>
ffffffffc0201270:	0d300593          	li	a1,211
ffffffffc0201274:	00003517          	auipc	a0,0x3
ffffffffc0201278:	60c50513          	addi	a0,a0,1548 # ffffffffc0204880 <commands+0x820>
ffffffffc020127c:	9deff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201280:	00003697          	auipc	a3,0x3
ffffffffc0201284:	67868693          	addi	a3,a3,1656 # ffffffffc02048f8 <commands+0x898>
ffffffffc0201288:	00003617          	auipc	a2,0x3
ffffffffc020128c:	5e060613          	addi	a2,a2,1504 # ffffffffc0204868 <commands+0x808>
ffffffffc0201290:	0bb00593          	li	a1,187
ffffffffc0201294:	00003517          	auipc	a0,0x3
ffffffffc0201298:	5ec50513          	addi	a0,a0,1516 # ffffffffc0204880 <commands+0x820>
ffffffffc020129c:	9beff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(count == 0);
ffffffffc02012a0:	00004697          	auipc	a3,0x4
ffffffffc02012a4:	90068693          	addi	a3,a3,-1792 # ffffffffc0204ba0 <commands+0xb40>
ffffffffc02012a8:	00003617          	auipc	a2,0x3
ffffffffc02012ac:	5c060613          	addi	a2,a2,1472 # ffffffffc0204868 <commands+0x808>
ffffffffc02012b0:	12500593          	li	a1,293
ffffffffc02012b4:	00003517          	auipc	a0,0x3
ffffffffc02012b8:	5cc50513          	addi	a0,a0,1484 # ffffffffc0204880 <commands+0x820>
ffffffffc02012bc:	99eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc02012c0:	00003697          	auipc	a3,0x3
ffffffffc02012c4:	78068693          	addi	a3,a3,1920 # ffffffffc0204a40 <commands+0x9e0>
ffffffffc02012c8:	00003617          	auipc	a2,0x3
ffffffffc02012cc:	5a060613          	addi	a2,a2,1440 # ffffffffc0204868 <commands+0x808>
ffffffffc02012d0:	11a00593          	li	a1,282
ffffffffc02012d4:	00003517          	auipc	a0,0x3
ffffffffc02012d8:	5ac50513          	addi	a0,a0,1452 # ffffffffc0204880 <commands+0x820>
ffffffffc02012dc:	97eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012e0:	00003697          	auipc	a3,0x3
ffffffffc02012e4:	70068693          	addi	a3,a3,1792 # ffffffffc02049e0 <commands+0x980>
ffffffffc02012e8:	00003617          	auipc	a2,0x3
ffffffffc02012ec:	58060613          	addi	a2,a2,1408 # ffffffffc0204868 <commands+0x808>
ffffffffc02012f0:	11800593          	li	a1,280
ffffffffc02012f4:	00003517          	auipc	a0,0x3
ffffffffc02012f8:	58c50513          	addi	a0,a0,1420 # ffffffffc0204880 <commands+0x820>
ffffffffc02012fc:	95eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201300:	00003697          	auipc	a3,0x3
ffffffffc0201304:	6a068693          	addi	a3,a3,1696 # ffffffffc02049a0 <commands+0x940>
ffffffffc0201308:	00003617          	auipc	a2,0x3
ffffffffc020130c:	56060613          	addi	a2,a2,1376 # ffffffffc0204868 <commands+0x808>
ffffffffc0201310:	0c100593          	li	a1,193
ffffffffc0201314:	00003517          	auipc	a0,0x3
ffffffffc0201318:	56c50513          	addi	a0,a0,1388 # ffffffffc0204880 <commands+0x820>
ffffffffc020131c:	93eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201320:	00004697          	auipc	a3,0x4
ffffffffc0201324:	84068693          	addi	a3,a3,-1984 # ffffffffc0204b60 <commands+0xb00>
ffffffffc0201328:	00003617          	auipc	a2,0x3
ffffffffc020132c:	54060613          	addi	a2,a2,1344 # ffffffffc0204868 <commands+0x808>
ffffffffc0201330:	11200593          	li	a1,274
ffffffffc0201334:	00003517          	auipc	a0,0x3
ffffffffc0201338:	54c50513          	addi	a0,a0,1356 # ffffffffc0204880 <commands+0x820>
ffffffffc020133c:	91eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201340:	00004697          	auipc	a3,0x4
ffffffffc0201344:	80068693          	addi	a3,a3,-2048 # ffffffffc0204b40 <commands+0xae0>
ffffffffc0201348:	00003617          	auipc	a2,0x3
ffffffffc020134c:	52060613          	addi	a2,a2,1312 # ffffffffc0204868 <commands+0x808>
ffffffffc0201350:	11000593          	li	a1,272
ffffffffc0201354:	00003517          	auipc	a0,0x3
ffffffffc0201358:	52c50513          	addi	a0,a0,1324 # ffffffffc0204880 <commands+0x820>
ffffffffc020135c:	8feff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201360:	00003697          	auipc	a3,0x3
ffffffffc0201364:	7b868693          	addi	a3,a3,1976 # ffffffffc0204b18 <commands+0xab8>
ffffffffc0201368:	00003617          	auipc	a2,0x3
ffffffffc020136c:	50060613          	addi	a2,a2,1280 # ffffffffc0204868 <commands+0x808>
ffffffffc0201370:	10e00593          	li	a1,270
ffffffffc0201374:	00003517          	auipc	a0,0x3
ffffffffc0201378:	50c50513          	addi	a0,a0,1292 # ffffffffc0204880 <commands+0x820>
ffffffffc020137c:	8deff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201380:	00003697          	auipc	a3,0x3
ffffffffc0201384:	77068693          	addi	a3,a3,1904 # ffffffffc0204af0 <commands+0xa90>
ffffffffc0201388:	00003617          	auipc	a2,0x3
ffffffffc020138c:	4e060613          	addi	a2,a2,1248 # ffffffffc0204868 <commands+0x808>
ffffffffc0201390:	10d00593          	li	a1,269
ffffffffc0201394:	00003517          	auipc	a0,0x3
ffffffffc0201398:	4ec50513          	addi	a0,a0,1260 # ffffffffc0204880 <commands+0x820>
ffffffffc020139c:	8beff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 + 2 == p1);
ffffffffc02013a0:	00003697          	auipc	a3,0x3
ffffffffc02013a4:	74068693          	addi	a3,a3,1856 # ffffffffc0204ae0 <commands+0xa80>
ffffffffc02013a8:	00003617          	auipc	a2,0x3
ffffffffc02013ac:	4c060613          	addi	a2,a2,1216 # ffffffffc0204868 <commands+0x808>
ffffffffc02013b0:	10800593          	li	a1,264
ffffffffc02013b4:	00003517          	auipc	a0,0x3
ffffffffc02013b8:	4cc50513          	addi	a0,a0,1228 # ffffffffc0204880 <commands+0x820>
ffffffffc02013bc:	89eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02013c0:	00003697          	auipc	a3,0x3
ffffffffc02013c4:	62068693          	addi	a3,a3,1568 # ffffffffc02049e0 <commands+0x980>
ffffffffc02013c8:	00003617          	auipc	a2,0x3
ffffffffc02013cc:	4a060613          	addi	a2,a2,1184 # ffffffffc0204868 <commands+0x808>
ffffffffc02013d0:	10700593          	li	a1,263
ffffffffc02013d4:	00003517          	auipc	a0,0x3
ffffffffc02013d8:	4ac50513          	addi	a0,a0,1196 # ffffffffc0204880 <commands+0x820>
ffffffffc02013dc:	87eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02013e0:	00003697          	auipc	a3,0x3
ffffffffc02013e4:	6e068693          	addi	a3,a3,1760 # ffffffffc0204ac0 <commands+0xa60>
ffffffffc02013e8:	00003617          	auipc	a2,0x3
ffffffffc02013ec:	48060613          	addi	a2,a2,1152 # ffffffffc0204868 <commands+0x808>
ffffffffc02013f0:	10600593          	li	a1,262
ffffffffc02013f4:	00003517          	auipc	a0,0x3
ffffffffc02013f8:	48c50513          	addi	a0,a0,1164 # ffffffffc0204880 <commands+0x820>
ffffffffc02013fc:	85eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201400:	00003697          	auipc	a3,0x3
ffffffffc0201404:	69068693          	addi	a3,a3,1680 # ffffffffc0204a90 <commands+0xa30>
ffffffffc0201408:	00003617          	auipc	a2,0x3
ffffffffc020140c:	46060613          	addi	a2,a2,1120 # ffffffffc0204868 <commands+0x808>
ffffffffc0201410:	10500593          	li	a1,261
ffffffffc0201414:	00003517          	auipc	a0,0x3
ffffffffc0201418:	46c50513          	addi	a0,a0,1132 # ffffffffc0204880 <commands+0x820>
ffffffffc020141c:	83eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201420:	00003697          	auipc	a3,0x3
ffffffffc0201424:	65868693          	addi	a3,a3,1624 # ffffffffc0204a78 <commands+0xa18>
ffffffffc0201428:	00003617          	auipc	a2,0x3
ffffffffc020142c:	44060613          	addi	a2,a2,1088 # ffffffffc0204868 <commands+0x808>
ffffffffc0201430:	10400593          	li	a1,260
ffffffffc0201434:	00003517          	auipc	a0,0x3
ffffffffc0201438:	44c50513          	addi	a0,a0,1100 # ffffffffc0204880 <commands+0x820>
ffffffffc020143c:	81eff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201440:	00003697          	auipc	a3,0x3
ffffffffc0201444:	5a068693          	addi	a3,a3,1440 # ffffffffc02049e0 <commands+0x980>
ffffffffc0201448:	00003617          	auipc	a2,0x3
ffffffffc020144c:	42060613          	addi	a2,a2,1056 # ffffffffc0204868 <commands+0x808>
ffffffffc0201450:	0fe00593          	li	a1,254
ffffffffc0201454:	00003517          	auipc	a0,0x3
ffffffffc0201458:	42c50513          	addi	a0,a0,1068 # ffffffffc0204880 <commands+0x820>
ffffffffc020145c:	ffffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!PageProperty(p0));
ffffffffc0201460:	00003697          	auipc	a3,0x3
ffffffffc0201464:	60068693          	addi	a3,a3,1536 # ffffffffc0204a60 <commands+0xa00>
ffffffffc0201468:	00003617          	auipc	a2,0x3
ffffffffc020146c:	40060613          	addi	a2,a2,1024 # ffffffffc0204868 <commands+0x808>
ffffffffc0201470:	0f900593          	li	a1,249
ffffffffc0201474:	00003517          	auipc	a0,0x3
ffffffffc0201478:	40c50513          	addi	a0,a0,1036 # ffffffffc0204880 <commands+0x820>
ffffffffc020147c:	fdffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201480:	00003697          	auipc	a3,0x3
ffffffffc0201484:	70068693          	addi	a3,a3,1792 # ffffffffc0204b80 <commands+0xb20>
ffffffffc0201488:	00003617          	auipc	a2,0x3
ffffffffc020148c:	3e060613          	addi	a2,a2,992 # ffffffffc0204868 <commands+0x808>
ffffffffc0201490:	11700593          	li	a1,279
ffffffffc0201494:	00003517          	auipc	a0,0x3
ffffffffc0201498:	3ec50513          	addi	a0,a0,1004 # ffffffffc0204880 <commands+0x820>
ffffffffc020149c:	fbffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == 0);
ffffffffc02014a0:	00003697          	auipc	a3,0x3
ffffffffc02014a4:	71068693          	addi	a3,a3,1808 # ffffffffc0204bb0 <commands+0xb50>
ffffffffc02014a8:	00003617          	auipc	a2,0x3
ffffffffc02014ac:	3c060613          	addi	a2,a2,960 # ffffffffc0204868 <commands+0x808>
ffffffffc02014b0:	12600593          	li	a1,294
ffffffffc02014b4:	00003517          	auipc	a0,0x3
ffffffffc02014b8:	3cc50513          	addi	a0,a0,972 # ffffffffc0204880 <commands+0x820>
ffffffffc02014bc:	f9ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == nr_free_pages());
ffffffffc02014c0:	00003697          	auipc	a3,0x3
ffffffffc02014c4:	3d868693          	addi	a3,a3,984 # ffffffffc0204898 <commands+0x838>
ffffffffc02014c8:	00003617          	auipc	a2,0x3
ffffffffc02014cc:	3a060613          	addi	a2,a2,928 # ffffffffc0204868 <commands+0x808>
ffffffffc02014d0:	0f300593          	li	a1,243
ffffffffc02014d4:	00003517          	auipc	a0,0x3
ffffffffc02014d8:	3ac50513          	addi	a0,a0,940 # ffffffffc0204880 <commands+0x820>
ffffffffc02014dc:	f7ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02014e0:	00003697          	auipc	a3,0x3
ffffffffc02014e4:	3f868693          	addi	a3,a3,1016 # ffffffffc02048d8 <commands+0x878>
ffffffffc02014e8:	00003617          	auipc	a2,0x3
ffffffffc02014ec:	38060613          	addi	a2,a2,896 # ffffffffc0204868 <commands+0x808>
ffffffffc02014f0:	0ba00593          	li	a1,186
ffffffffc02014f4:	00003517          	auipc	a0,0x3
ffffffffc02014f8:	38c50513          	addi	a0,a0,908 # ffffffffc0204880 <commands+0x820>
...
ffffffffc0201630:	59c68693          	addi	a3,a3,1436 # ffffffffc0204bc8 <commands+0xb68>
ffffffffc0201634:	00003617          	auipc	a2,0x3
ffffffffc0201638:	23460613          	addi	a2,a2,564 # ffffffffc0204868 <commands+0x808>
ffffffffc020163c:	08300593          	li	a1,131
ffffffffc0201640:	00003517          	auipc	a0,0x3
ffffffffc0201644:	24050513          	addi	a0,a0,576 # ffffffffc0204880 <commands+0x820>
ffffffffc0201648:	e13fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc020164c:	00003697          	auipc	a3,0x3
ffffffffc0201650:	57468693          	addi	a3,a3,1396 # ffffffffc0204bc0 <commands+0xb60>
ffffffffc0201654:	00003617          	auipc	a2,0x3
ffffffffc0201658:	21460613          	addi	a2,a2,532 # ffffffffc0204868 <commands+0x808>
ffffffffc020165c:	08000593          	li	a1,128
ffffffffc0201660:	00003517          	auipc	a0,0x3
ffffffffc0201664:	22050513          	addi	a0,a0,544 # ffffffffc0204880 <commands+0x820>
...
ffffffffc0201702:	4c268693          	addi	a3,a3,1218 # ffffffffc0204bc0 <commands+0xb60>
ffffffffc0201706:	00003617          	auipc	a2,0x3
ffffffffc020170a:	16260613          	addi	a2,a2,354 # ffffffffc0204868 <commands+0x808>
ffffffffc020170e:	06200593          	li	a1,98
ffffffffc0201712:	00003517          	auipc	a0,0x3
ffffffffc0201716:	16e50513          	addi	a0,a0,366 # ffffffffc0204880 <commands+0x820>
default_alloc_pages(size_t n) {
...
ffffffffc02017d4:	42068693          	addi	a3,a3,1056 # ffffffffc0204bf0 <commands+0xb90>
ffffffffc02017d8:	00003617          	auipc	a2,0x3
ffffffffc02017dc:	09060613          	addi	a2,a2,144 # ffffffffc0204868 <commands+0x808>
ffffffffc02017e0:	04900593          	li	a1,73
ffffffffc02017e4:	00003517          	auipc	a0,0x3
ffffffffc02017e8:	09c50513          	addi	a0,a0,156 # ffffffffc0204880 <commands+0x820>
ffffffffc02017ec:	c6ffe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc02017f0:	00003697          	auipc	a3,0x3
ffffffffc02017f4:	3d068693          	addi	a3,a3,976 # ffffffffc0204bc0 <commands+0xb60>
ffffffffc02017f8:	00003617          	auipc	a2,0x3
ffffffffc02017fc:	07060613          	addi	a2,a2,112 # ffffffffc0204868 <commands+0x808>
ffffffffc0201800:	04600593          	li	a1,70
ffffffffc0201804:	00003517          	auipc	a0,0x3
ffffffffc0201808:	07c50513          	addi	a0,a0,124 # ffffffffc0204880 <commands+0x820>
...
ffffffffc02018e4:	ff86b683          	ld	a3,-8(a3) # ffffffffc02058d8 <nbase>
...
ffffffffc0201914:	34060613          	addi	a2,a2,832 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0201918:	07100593          	li	a1,113
ffffffffc020191c:	00003517          	auipc	a0,0x3
ffffffffc0201920:	35c50513          	addi	a0,a0,860 # ffffffffc0204c78 <default_pmm_manager+0x60>
...
ffffffffc0201a02:	28a68693          	addi	a3,a3,650 # ffffffffc0204c88 <default_pmm_manager+0x70>
ffffffffc0201a06:	00003617          	auipc	a2,0x3
ffffffffc0201a0a:	e6260613          	addi	a2,a2,-414 # ffffffffc0204868 <commands+0x808>
ffffffffc0201a0e:	06300593          	li	a1,99
ffffffffc0201a12:	00003517          	auipc	a0,0x3
ffffffffc0201a16:	29650513          	addi	a0,a0,662 # ffffffffc0204ca8 <default_pmm_manager+0x90>
...
ffffffffc0201a24:	2a050513          	addi	a0,a0,672 # ffffffffc0204cc0 <default_pmm_manager+0xa8>
{
...
ffffffffc0201a34:	2a850513          	addi	a0,a0,680 # ffffffffc0204cd8 <default_pmm_manager+0xc0>
}
...
ffffffffc0201b58:	d8453503          	ld	a0,-636(a0) # ffffffffc02058d8 <nbase>
...
ffffffffc0201bb6:	16e60613          	addi	a2,a2,366 # ffffffffc0204d20 <default_pmm_manager+0x108>
ffffffffc0201bba:	06900593          	li	a1,105
ffffffffc0201bbe:	00003517          	auipc	a0,0x3
ffffffffc0201bc2:	0ba50513          	addi	a0,a0,186 # ffffffffc0204c78 <default_pmm_manager+0x60>
...
ffffffffc0201bd0:	12c60613          	addi	a2,a2,300 # ffffffffc0204cf8 <default_pmm_manager+0xe0>
ffffffffc0201bd4:	07700593          	li	a1,119
ffffffffc0201bd8:	00003517          	auipc	a0,0x3
ffffffffc0201bdc:	0a050513          	addi	a0,a0,160 # ffffffffc0204c78 <default_pmm_manager+0x60>
...
ffffffffc0201bea:	13a60613          	addi	a2,a2,314 # ffffffffc0204d20 <default_pmm_manager+0x108>
ffffffffc0201bee:	06900593          	li	a1,105
ffffffffc0201bf2:	00003517          	auipc	a0,0x3
ffffffffc0201bf6:	08650513          	addi	a0,a0,134 # ffffffffc0204c78 <default_pmm_manager+0x60>
pa2page(uintptr_t pa)
...
ffffffffc0201c06:	13e60613          	addi	a2,a2,318 # ffffffffc0204d40 <default_pmm_manager+0x128>
ffffffffc0201c0a:	07f00593          	li	a1,127
ffffffffc0201c0e:	00003517          	auipc	a0,0x3
ffffffffc0201c12:	06a50513          	addi	a0,a0,106 # ffffffffc0204c78 <default_pmm_manager+0x60>
pte2page(pte_t pte)
...
ffffffffc0201d6c:	03c020ef          	jal	ra,ffffffffc0203da8 <memset>
    return page - pages + nbase;
...
ffffffffc0201e0e:	79b010ef          	jal	ra,ffffffffc0203da8 <memset>
    return page - pages + nbase;
...
ffffffffc0201e9c:	db860613          	addi	a2,a2,-584 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0201ea0:	0fb00593          	li	a1,251
ffffffffc0201ea4:	00003517          	auipc	a0,0x3
ffffffffc0201ea8:	ec450513          	addi	a0,a0,-316 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0201eac:	daefe0ef          	jal	ra,ffffffffc020045a <__panic>
    pde_t *pdep0 = &((pte_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc0201eb0:	00003617          	auipc	a2,0x3
ffffffffc0201eb4:	da060613          	addi	a2,a2,-608 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0201eb8:	0ee00593          	li	a1,238
ffffffffc0201ebc:	00003517          	auipc	a0,0x3
ffffffffc0201ec0:	eac50513          	addi	a0,a0,-340 # ffffffffc0204d68 <default_pmm_manager+0x150>
...
ffffffffc0201ece:	d8660613          	addi	a2,a2,-634 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0201ed2:	0eb00593          	li	a1,235
ffffffffc0201ed6:	00003517          	auipc	a0,0x3
ffffffffc0201eda:	e9250513          	addi	a0,a0,-366 # ffffffffc0204d68 <default_pmm_manager+0x150>
...
ffffffffc0201ee8:	d6c60613          	addi	a2,a2,-660 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0201eec:	0f800593          	li	a1,248
ffffffffc0201ef0:	00003517          	auipc	a0,0x3
ffffffffc0201ef4:	e7850513          	addi	a0,a0,-392 # ffffffffc0204d68 <default_pmm_manager+0x150>
...
ffffffffc02020e6:	b3678793          	addi	a5,a5,-1226 # ffffffffc0204c18 <default_pmm_manager>
...
ffffffffc02020f4:	c8850513          	addi	a0,a0,-888 # ffffffffc0204d78 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0202148:	c6c50513          	addi	a0,a0,-916 # ffffffffc0204db0 <default_pmm_manager+0x198>
...
ffffffffc0202160:	c6c50513          	addi	a0,a0,-916 # ffffffffc0204dc8 <default_pmm_manager+0x1b0>
...
ffffffffc02021e8:	c0c50513          	addi	a0,a0,-1012 # ffffffffc0204df0 <default_pmm_manager+0x1d8>
...
ffffffffc0202204:	c0850513          	addi	a0,a0,-1016 # ffffffffc0204e08 <default_pmm_manager+0x1f0>
...
ffffffffc02024ba:	c7a50513          	addi	a0,a0,-902 # ffffffffc0205130 <default_pmm_manager+0x518>
...
ffffffffc020257e:	cfe58593          	addi	a1,a1,-770 # ffffffffc0205278 <default_pmm_manager+0x660>
ffffffffc0202582:	10000513          	li	a0,256
ffffffffc0202586:	7b6010ef          	jal	ra,ffffffffc0203d3c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020258a:	10040593          	addi	a1,s0,256
ffffffffc020258e:	10000513          	li	a0,256
ffffffffc0202592:	7bc010ef          	jal	ra,ffffffffc0203d4e <strcmp>
...
ffffffffc02025c4:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc02025c8:	73e010ef          	jal	ra,ffffffffc0203d06 <strlen>
...
ffffffffc020268c:	c6850513          	addi	a0,a0,-920 # ffffffffc02052f0 <default_pmm_manager+0x6d8>
...
ffffffffc02027f4:	46060613          	addi	a2,a2,1120 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc02027f8:	1a400593          	li	a1,420
ffffffffc02027fc:	00002517          	auipc	a0,0x2
ffffffffc0202800:	56c50513          	addi	a0,a0,1388 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202804:	c57fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202808:	00003697          	auipc	a3,0x3
ffffffffc020280c:	98868693          	addi	a3,a3,-1656 # ffffffffc0205190 <default_pmm_manager+0x578>
ffffffffc0202810:	00002617          	auipc	a2,0x2
ffffffffc0202814:	05860613          	addi	a2,a2,88 # ffffffffc0204868 <commands+0x808>
ffffffffc0202818:	1a500593          	li	a1,421
ffffffffc020281c:	00002517          	auipc	a0,0x2
ffffffffc0202820:	54c50513          	addi	a0,a0,1356 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202824:	c37fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202828:	00003697          	auipc	a3,0x3
ffffffffc020282c:	92868693          	addi	a3,a3,-1752 # ffffffffc0205150 <default_pmm_manager+0x538>
ffffffffc0202830:	00002617          	auipc	a2,0x2
ffffffffc0202834:	03860613          	addi	a2,a2,56 # ffffffffc0204868 <commands+0x808>
ffffffffc0202838:	1a400593          	li	a1,420
ffffffffc020283c:	00002517          	auipc	a0,0x2
ffffffffc0202840:	52c50513          	addi	a0,a0,1324 # ffffffffc0204d68 <default_pmm_manager+0x150>
...
ffffffffc0202854:	6f868693          	addi	a3,a3,1784 # ffffffffc0204f48 <default_pmm_manager+0x330>
ffffffffc0202858:	00002617          	auipc	a2,0x2
ffffffffc020285c:	01060613          	addi	a2,a2,16 # ffffffffc0204868 <commands+0x808>
ffffffffc0202860:	17400593          	li	a1,372
ffffffffc0202864:	00002517          	auipc	a0,0x2
ffffffffc0202868:	50450513          	addi	a0,a0,1284 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc020286c:	beffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc0202870:	00002697          	auipc	a3,0x2
ffffffffc0202874:	61868693          	addi	a3,a3,1560 # ffffffffc0204e88 <default_pmm_manager+0x270>
ffffffffc0202878:	00002617          	auipc	a2,0x2
ffffffffc020287c:	ff060613          	addi	a2,a2,-16 # ffffffffc0204868 <commands+0x808>
ffffffffc0202880:	16700593          	li	a1,359
ffffffffc0202884:	00002517          	auipc	a0,0x2
ffffffffc0202888:	4e450513          	addi	a0,a0,1252 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc020288c:	bcffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc0202890:	00002697          	auipc	a3,0x2
ffffffffc0202894:	5b868693          	addi	a3,a3,1464 # ffffffffc0204e48 <default_pmm_manager+0x230>
ffffffffc0202898:	00002617          	auipc	a2,0x2
ffffffffc020289c:	fd060613          	addi	a2,a2,-48 # ffffffffc0204868 <commands+0x808>
ffffffffc02028a0:	16600593          	li	a1,358
ffffffffc02028a4:	00002517          	auipc	a0,0x2
ffffffffc02028a8:	4c450513          	addi	a0,a0,1220 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc02028ac:	baffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc02028b0:	00002697          	auipc	a3,0x2
ffffffffc02028b4:	57868693          	addi	a3,a3,1400 # ffffffffc0204e28 <default_pmm_manager+0x210>
ffffffffc02028b8:	00002617          	auipc	a2,0x2
ffffffffc02028bc:	fb060613          	addi	a2,a2,-80 # ffffffffc0204868 <commands+0x808>
ffffffffc02028c0:	16500593          	li	a1,357
ffffffffc02028c4:	00002517          	auipc	a0,0x2
ffffffffc02028c8:	4a450513          	addi	a0,a0,1188 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc02028cc:	b8ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    return KADDR(page2pa(page));
ffffffffc02028d0:	00002617          	auipc	a2,0x2
ffffffffc02028d4:	38060613          	addi	a2,a2,896 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc02028d8:	07100593          	li	a1,113
ffffffffc02028dc:	00002517          	auipc	a0,0x2
ffffffffc02028e0:	39c50513          	addi	a0,a0,924 # ffffffffc0204c78 <default_pmm_manager+0x60>
ffffffffc02028e4:	b77fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc02028e8:	00002697          	auipc	a3,0x2
ffffffffc02028ec:	7f068693          	addi	a3,a3,2032 # ffffffffc02050d8 <default_pmm_manager+0x4c0>
ffffffffc02028f0:	00002617          	auipc	a2,0x2
ffffffffc02028f4:	f7860613          	addi	a2,a2,-136 # ffffffffc0204868 <commands+0x808>
ffffffffc02028f8:	18d00593          	li	a1,397
ffffffffc02028fc:	00002517          	auipc	a0,0x2
ffffffffc0202900:	46c50513          	addi	a0,a0,1132 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202904:	b57fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202908:	00002697          	auipc	a3,0x2
ffffffffc020290c:	78868693          	addi	a3,a3,1928 # ffffffffc0205090 <default_pmm_manager+0x478>
ffffffffc0202910:	00002617          	auipc	a2,0x2
ffffffffc0202914:	f5860613          	addi	a2,a2,-168 # ffffffffc0204868 <commands+0x808>
ffffffffc0202918:	18b00593          	li	a1,395
ffffffffc020291c:	00002517          	auipc	a0,0x2
ffffffffc0202920:	44c50513          	addi	a0,a0,1100 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202924:	b37fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202928:	00002697          	auipc	a3,0x2
ffffffffc020292c:	79868693          	addi	a3,a3,1944 # ffffffffc02050c0 <default_pmm_manager+0x4a8>
ffffffffc0202930:	00002617          	auipc	a2,0x2
ffffffffc0202934:	f3860613          	addi	a2,a2,-200 # ffffffffc0204868 <commands+0x808>
ffffffffc0202938:	18a00593          	li	a1,394
ffffffffc020293c:	00002517          	auipc	a0,0x2
ffffffffc0202940:	42c50513          	addi	a0,a0,1068 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202944:	b17fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc0202948:	00003697          	auipc	a3,0x3
ffffffffc020294c:	86068693          	addi	a3,a3,-1952 # ffffffffc02051a8 <default_pmm_manager+0x590>
ffffffffc0202950:	00002617          	auipc	a2,0x2
ffffffffc0202954:	f1860613          	addi	a2,a2,-232 # ffffffffc0204868 <commands+0x808>
ffffffffc0202958:	1a800593          	li	a1,424
ffffffffc020295c:	00002517          	auipc	a0,0x2
ffffffffc0202960:	40c50513          	addi	a0,a0,1036 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202964:	af7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202968:	00002697          	auipc	a3,0x2
ffffffffc020296c:	7a068693          	addi	a3,a3,1952 # ffffffffc0205108 <default_pmm_manager+0x4f0>
ffffffffc0202970:	00002617          	auipc	a2,0x2
ffffffffc0202974:	ef860613          	addi	a2,a2,-264 # ffffffffc0204868 <commands+0x808>
ffffffffc0202978:	19500593          	li	a1,405
ffffffffc020297c:	00002517          	auipc	a0,0x2
ffffffffc0202980:	3ec50513          	addi	a0,a0,1004 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202984:	ad7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202988:	00003697          	auipc	a3,0x3
ffffffffc020298c:	87868693          	addi	a3,a3,-1928 # ffffffffc0205200 <default_pmm_manager+0x5e8>
ffffffffc0202990:	00002617          	auipc	a2,0x2
ffffffffc0202994:	ed860613          	addi	a2,a2,-296 # ffffffffc0204868 <commands+0x808>
ffffffffc0202998:	1ad00593          	li	a1,429
ffffffffc020299c:	00002517          	auipc	a0,0x2
ffffffffc02029a0:	3cc50513          	addi	a0,a0,972 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc02029a4:	ab7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc02029a8:	00003697          	auipc	a3,0x3
ffffffffc02029ac:	81868693          	addi	a3,a3,-2024 # ffffffffc02051c0 <default_pmm_manager+0x5a8>
ffffffffc02029b0:	00002617          	auipc	a2,0x2
ffffffffc02029b4:	eb860613          	addi	a2,a2,-328 # ffffffffc0204868 <commands+0x808>
ffffffffc02029b8:	1ac00593          	li	a1,428
ffffffffc02029bc:	00002517          	auipc	a0,0x2
ffffffffc02029c0:	3ac50513          	addi	a0,a0,940 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc02029c4:	a97fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02029c8:	00002697          	auipc	a3,0x2
ffffffffc02029cc:	6c868693          	addi	a3,a3,1736 # ffffffffc0205090 <default_pmm_manager+0x478>
ffffffffc02029d0:	00002617          	auipc	a2,0x2
ffffffffc02029d4:	e9860613          	addi	a2,a2,-360 # ffffffffc0204868 <commands+0x808>
ffffffffc02029d8:	18700593          	li	a1,391
ffffffffc02029dc:	00002517          	auipc	a0,0x2
ffffffffc02029e0:	38c50513          	addi	a0,a0,908 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc02029e4:	a77fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029e8:	00002697          	auipc	a3,0x2
ffffffffc02029ec:	54868693          	addi	a3,a3,1352 # ffffffffc0204f30 <default_pmm_manager+0x318>
ffffffffc02029f0:	00002617          	auipc	a2,0x2
ffffffffc02029f4:	e7860613          	addi	a2,a2,-392 # ffffffffc0204868 <commands+0x808>
ffffffffc02029f8:	18600593          	li	a1,390
ffffffffc02029fc:	00002517          	auipc	a0,0x2
ffffffffc0202a00:	36c50513          	addi	a0,a0,876 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202a04:	a57fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202a08:	00002697          	auipc	a3,0x2
ffffffffc0202a0c:	6a068693          	addi	a3,a3,1696 # ffffffffc02050a8 <default_pmm_manager+0x490>
ffffffffc0202a10:	00002617          	auipc	a2,0x2
ffffffffc0202a14:	e5860613          	addi	a2,a2,-424 # ffffffffc0204868 <commands+0x808>
ffffffffc0202a18:	18300593          	li	a1,387
ffffffffc0202a1c:	00002517          	auipc	a0,0x2
ffffffffc0202a20:	34c50513          	addi	a0,a0,844 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202a24:	a37fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202a28:	00002697          	auipc	a3,0x2
ffffffffc0202a2c:	4f068693          	addi	a3,a3,1264 # ffffffffc0204f18 <default_pmm_manager+0x300>
ffffffffc0202a30:	00002617          	auipc	a2,0x2
ffffffffc0202a34:	e3860613          	addi	a2,a2,-456 # ffffffffc0204868 <commands+0x808>
ffffffffc0202a38:	18200593          	li	a1,386
ffffffffc0202a3c:	00002517          	auipc	a0,0x2
ffffffffc0202a40:	32c50513          	addi	a0,a0,812 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202a44:	a17fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202a48:	00002697          	auipc	a3,0x2
ffffffffc0202a4c:	57068693          	addi	a3,a3,1392 # ffffffffc0204fb8 <default_pmm_manager+0x3a0>
ffffffffc0202a50:	00002617          	auipc	a2,0x2
ffffffffc0202a54:	e1860613          	addi	a2,a2,-488 # ffffffffc0204868 <commands+0x808>
ffffffffc0202a58:	18100593          	li	a1,385
ffffffffc0202a5c:	00002517          	auipc	a0,0x2
ffffffffc0202a60:	30c50513          	addi	a0,a0,780 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202a64:	9f7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202a68:	00002697          	auipc	a3,0x2
ffffffffc0202a6c:	62868693          	addi	a3,a3,1576 # ffffffffc0205090 <default_pmm_manager+0x478>
ffffffffc0202a70:	00002617          	auipc	a2,0x2
ffffffffc0202a74:	df860613          	addi	a2,a2,-520 # ffffffffc0204868 <commands+0x808>
ffffffffc0202a78:	18000593          	li	a1,384
ffffffffc0202a7c:	00002517          	auipc	a0,0x2
ffffffffc0202a80:	2ec50513          	addi	a0,a0,748 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202a84:	9d7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202a88:	00002697          	auipc	a3,0x2
ffffffffc0202a8c:	5f068693          	addi	a3,a3,1520 # ffffffffc0205078 <default_pmm_manager+0x460>
ffffffffc0202a90:	00002617          	auipc	a2,0x2
ffffffffc0202a94:	dd860613          	addi	a2,a2,-552 # ffffffffc0204868 <commands+0x808>
ffffffffc0202a98:	17f00593          	li	a1,383
ffffffffc0202a9c:	00002517          	auipc	a0,0x2
ffffffffc0202aa0:	2cc50513          	addi	a0,a0,716 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202aa4:	9b7fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0202aa8:	00002697          	auipc	a3,0x2
ffffffffc0202aac:	5a068693          	addi	a3,a3,1440 # ffffffffc0205048 <default_pmm_manager+0x430>
ffffffffc0202ab0:	00002617          	auipc	a2,0x2
ffffffffc0202ab4:	db860613          	addi	a2,a2,-584 # ffffffffc0204868 <commands+0x808>
ffffffffc0202ab8:	17e00593          	li	a1,382
ffffffffc0202abc:	00002517          	auipc	a0,0x2
ffffffffc0202ac0:	2ac50513          	addi	a0,a0,684 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202ac4:	997fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202ac8:	00002697          	auipc	a3,0x2
ffffffffc0202acc:	56868693          	addi	a3,a3,1384 # ffffffffc0205030 <default_pmm_manager+0x418>
ffffffffc0202ad0:	00002617          	auipc	a2,0x2
ffffffffc0202ad4:	d9860613          	addi	a2,a2,-616 # ffffffffc0204868 <commands+0x808>
ffffffffc0202ad8:	17c00593          	li	a1,380
ffffffffc0202adc:	00002517          	auipc	a0,0x2
ffffffffc0202ae0:	28c50513          	addi	a0,a0,652 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202ae4:	977fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc0202ae8:	00002697          	auipc	a3,0x2
ffffffffc0202aec:	52868693          	addi	a3,a3,1320 # ffffffffc0205010 <default_pmm_manager+0x3f8>
ffffffffc0202af0:	00002617          	auipc	a2,0x2
ffffffffc0202af4:	d7860613          	addi	a2,a2,-648 # ffffffffc0204868 <commands+0x808>
ffffffffc0202af8:	17b00593          	li	a1,379
ffffffffc0202afc:	00002517          	auipc	a0,0x2
ffffffffc0202b00:	26c50513          	addi	a0,a0,620 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202b04:	957fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202b08:	00002697          	auipc	a3,0x2
ffffffffc0202b0c:	4f868693          	addi	a3,a3,1272 # ffffffffc0205000 <default_pmm_manager+0x3e8>
ffffffffc0202b10:	00002617          	auipc	a2,0x2
ffffffffc0202b14:	d5860613          	addi	a2,a2,-680 # ffffffffc0204868 <commands+0x808>
ffffffffc0202b18:	17a00593          	li	a1,378
ffffffffc0202b1c:	00002517          	auipc	a0,0x2
ffffffffc0202b20:	24c50513          	addi	a0,a0,588 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202b24:	937fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202b28:	00002697          	auipc	a3,0x2
ffffffffc0202b2c:	4c868693          	addi	a3,a3,1224 # ffffffffc0204ff0 <default_pmm_manager+0x3d8>
ffffffffc0202b30:	00002617          	auipc	a2,0x2
ffffffffc0202b34:	d3860613          	addi	a2,a2,-712 # ffffffffc0204868 <commands+0x808>
ffffffffc0202b38:	17900593          	li	a1,377
ffffffffc0202b3c:	00002517          	auipc	a0,0x2
ffffffffc0202b40:	22c50513          	addi	a0,a0,556 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202b44:	917fd0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("DTB memory info not available");
ffffffffc0202b48:	00002617          	auipc	a2,0x2
ffffffffc0202b4c:	24860613          	addi	a2,a2,584 # ffffffffc0204d90 <default_pmm_manager+0x178>
ffffffffc0202b50:	06400593          	li	a1,100
ffffffffc0202b54:	00002517          	auipc	a0,0x2
ffffffffc0202b58:	21450513          	addi	a0,a0,532 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202b5c:	8fffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202b60:	00002697          	auipc	a3,0x2
ffffffffc0202b64:	5a868693          	addi	a3,a3,1448 # ffffffffc0205108 <default_pmm_manager+0x4f0>
ffffffffc0202b68:	00002617          	auipc	a2,0x2
ffffffffc0202b6c:	d0060613          	addi	a2,a2,-768 # ffffffffc0204868 <commands+0x808>
ffffffffc0202b70:	1bf00593          	li	a1,447
ffffffffc0202b74:	00002517          	auipc	a0,0x2
ffffffffc0202b78:	1f450513          	addi	a0,a0,500 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202b7c:	8dffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202b80:	00002697          	auipc	a3,0x2
ffffffffc0202b84:	43868693          	addi	a3,a3,1080 # ffffffffc0204fb8 <default_pmm_manager+0x3a0>
ffffffffc0202b88:	00002617          	auipc	a2,0x2
ffffffffc0202b8c:	ce060613          	addi	a2,a2,-800 # ffffffffc0204868 <commands+0x808>
ffffffffc0202b90:	17800593          	li	a1,376
ffffffffc0202b94:	00002517          	auipc	a0,0x2
ffffffffc0202b98:	1d450513          	addi	a0,a0,468 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202b9c:	8bffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202ba0:	00002697          	auipc	a3,0x2
ffffffffc0202ba4:	3d868693          	addi	a3,a3,984 # ffffffffc0204f78 <default_pmm_manager+0x360>
ffffffffc0202ba8:	00002617          	auipc	a2,0x2
ffffffffc0202bac:	cc060613          	addi	a2,a2,-832 # ffffffffc0204868 <commands+0x808>
ffffffffc0202bb0:	17700593          	li	a1,375
ffffffffc0202bb4:	00002517          	auipc	a0,0x2
ffffffffc0202bb8:	1b450513          	addi	a0,a0,436 # ffffffffc0204d68 <default_pmm_manager+0x150>
...
ffffffffc0202bc6:	08e60613          	addi	a2,a2,142 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0202bca:	17300593          	li	a1,371
ffffffffc0202bce:	00002517          	auipc	a0,0x2
ffffffffc0202bd2:	19a50513          	addi	a0,a0,410 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202bd6:	885fd0ef          	jal	ra,ffffffffc020045a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0202bda:	00002617          	auipc	a2,0x2
ffffffffc0202bde:	07660613          	addi	a2,a2,118 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc0202be2:	17200593          	li	a1,370
ffffffffc0202be6:	00002517          	auipc	a0,0x2
ffffffffc0202bea:	18250513          	addi	a0,a0,386 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202bee:	86dfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202bf2:	00002697          	auipc	a3,0x2
ffffffffc0202bf6:	33e68693          	addi	a3,a3,830 # ffffffffc0204f30 <default_pmm_manager+0x318>
ffffffffc0202bfa:	00002617          	auipc	a2,0x2
ffffffffc0202bfe:	c6e60613          	addi	a2,a2,-914 # ffffffffc0204868 <commands+0x808>
ffffffffc0202c02:	17000593          	li	a1,368
ffffffffc0202c06:	00002517          	auipc	a0,0x2
ffffffffc0202c0a:	16250513          	addi	a0,a0,354 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202c0e:	84dfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202c12:	00002697          	auipc	a3,0x2
ffffffffc0202c16:	30668693          	addi	a3,a3,774 # ffffffffc0204f18 <default_pmm_manager+0x300>
ffffffffc0202c1a:	00002617          	auipc	a2,0x2
ffffffffc0202c1e:	c4e60613          	addi	a2,a2,-946 # ffffffffc0204868 <commands+0x808>
ffffffffc0202c22:	16f00593          	li	a1,367
ffffffffc0202c26:	00002517          	auipc	a0,0x2
ffffffffc0202c2a:	14250513          	addi	a0,a0,322 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202c2e:	82dfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202c32:	00002697          	auipc	a3,0x2
ffffffffc0202c36:	69668693          	addi	a3,a3,1686 # ffffffffc02052c8 <default_pmm_manager+0x6b0>
ffffffffc0202c3a:	00002617          	auipc	a2,0x2
ffffffffc0202c3e:	c2e60613          	addi	a2,a2,-978 # ffffffffc0204868 <commands+0x808>
ffffffffc0202c42:	1b600593          	li	a1,438
ffffffffc0202c46:	00002517          	auipc	a0,0x2
ffffffffc0202c4a:	12250513          	addi	a0,a0,290 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202c4e:	80dfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202c52:	00002697          	auipc	a3,0x2
ffffffffc0202c56:	63e68693          	addi	a3,a3,1598 # ffffffffc0205290 <default_pmm_manager+0x678>
ffffffffc0202c5a:	00002617          	auipc	a2,0x2
ffffffffc0202c5e:	c0e60613          	addi	a2,a2,-1010 # ffffffffc0204868 <commands+0x808>
ffffffffc0202c62:	1b300593          	li	a1,435
ffffffffc0202c66:	00002517          	auipc	a0,0x2
ffffffffc0202c6a:	10250513          	addi	a0,a0,258 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202c6e:	fecfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202c72:	00002697          	auipc	a3,0x2
ffffffffc0202c76:	5ee68693          	addi	a3,a3,1518 # ffffffffc0205260 <default_pmm_manager+0x648>
ffffffffc0202c7a:	00002617          	auipc	a2,0x2
ffffffffc0202c7e:	bee60613          	addi	a2,a2,-1042 # ffffffffc0204868 <commands+0x808>
ffffffffc0202c82:	1af00593          	li	a1,431
ffffffffc0202c86:	00002517          	auipc	a0,0x2
ffffffffc0202c8a:	0e250513          	addi	a0,a0,226 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202c8e:	fccfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202c92:	00002697          	auipc	a3,0x2
ffffffffc0202c96:	58668693          	addi	a3,a3,1414 # ffffffffc0205218 <default_pmm_manager+0x600>
ffffffffc0202c9a:	00002617          	auipc	a2,0x2
ffffffffc0202c9e:	bce60613          	addi	a2,a2,-1074 # ffffffffc0204868 <commands+0x808>
ffffffffc0202ca2:	1ae00593          	li	a1,430
ffffffffc0202ca6:	00002517          	auipc	a0,0x2
ffffffffc0202caa:	0c250513          	addi	a0,a0,194 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202cae:	facfd0ef          	jal	ra,ffffffffc020045a <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc0202cb2:	00002617          	auipc	a2,0x2
ffffffffc0202cb6:	04660613          	addi	a2,a2,70 # ffffffffc0204cf8 <default_pmm_manager+0xe0>
ffffffffc0202cba:	0cb00593          	li	a1,203
ffffffffc0202cbe:	00002517          	auipc	a0,0x2
ffffffffc0202cc2:	0aa50513          	addi	a0,a0,170 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202cc6:	f94fd0ef          	jal	ra,ffffffffc020045a <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0202cca:	00002617          	auipc	a2,0x2
ffffffffc0202cce:	02e60613          	addi	a2,a2,46 # ffffffffc0204cf8 <default_pmm_manager+0xe0>
ffffffffc0202cd2:	08000593          	li	a1,128
ffffffffc0202cd6:	00002517          	auipc	a0,0x2
ffffffffc0202cda:	09250513          	addi	a0,a0,146 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202cde:	f7cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc0202ce2:	00002697          	auipc	a3,0x2
ffffffffc0202ce6:	20668693          	addi	a3,a3,518 # ffffffffc0204ee8 <default_pmm_manager+0x2d0>
ffffffffc0202cea:	00002617          	auipc	a2,0x2
ffffffffc0202cee:	b7e60613          	addi	a2,a2,-1154 # ffffffffc0204868 <commands+0x808>
ffffffffc0202cf2:	16e00593          	li	a1,366
ffffffffc0202cf6:	00002517          	auipc	a0,0x2
ffffffffc0202cfa:	07250513          	addi	a0,a0,114 # ffffffffc0204d68 <default_pmm_manager+0x150>
ffffffffc0202cfe:	f5cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);
ffffffffc0202d02:	00002697          	auipc	a3,0x2
ffffffffc0202d06:	1b668693          	addi	a3,a3,438 # ffffffffc0204eb8 <default_pmm_manager+0x2a0>
ffffffffc0202d0a:	00002617          	auipc	a2,0x2
ffffffffc0202d0e:	b5e60613          	addi	a2,a2,-1186 # ffffffffc0204868 <commands+0x808>
ffffffffc0202d12:	16b00593          	li	a1,363
ffffffffc0202d16:	00002517          	auipc	a0,0x2
ffffffffc0202d1a:	05250513          	addi	a0,a0,82 # ffffffffc0204d68 <default_pmm_manager+0x150>
...
ffffffffc0202d28:	5ec68693          	addi	a3,a3,1516 # ffffffffc0205310 <default_pmm_manager+0x6f8>
ffffffffc0202d2c:	00002617          	auipc	a2,0x2
ffffffffc0202d30:	b3c60613          	addi	a2,a2,-1220 # ffffffffc0204868 <commands+0x808>
ffffffffc0202d34:	08800593          	li	a1,136
ffffffffc0202d38:	00002517          	auipc	a0,0x2
ffffffffc0202d3c:	5f850513          	addi	a0,a0,1528 # ffffffffc0205330 <default_pmm_manager+0x718>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc0202dfa:	54a68693          	addi	a3,a3,1354 # ffffffffc0205340 <default_pmm_manager+0x728>
ffffffffc0202dfe:	00002617          	auipc	a2,0x2
ffffffffc0202e02:	a6a60613          	addi	a2,a2,-1430 # ffffffffc0204868 <commands+0x808>
ffffffffc0202e06:	08e00593          	li	a1,142
ffffffffc0202e0a:	00002517          	auipc	a0,0x2
ffffffffc0202e0e:	52650513          	addi	a0,a0,1318 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0202e12:	e48fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0202e16:	00002697          	auipc	a3,0x2
ffffffffc0202e1a:	56a68693          	addi	a3,a3,1386 # ffffffffc0205380 <default_pmm_manager+0x768>
ffffffffc0202e1e:	00002617          	auipc	a2,0x2
ffffffffc0202e22:	a4a60613          	addi	a2,a2,-1462 # ffffffffc0204868 <commands+0x808>
ffffffffc0202e26:	08700593          	li	a1,135
ffffffffc0202e2a:	00002517          	auipc	a0,0x2
ffffffffc0202e2e:	50650513          	addi	a0,a0,1286 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0202e32:	e28fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0202e36:	00002697          	auipc	a3,0x2
ffffffffc0202e3a:	52a68693          	addi	a3,a3,1322 # ffffffffc0205360 <default_pmm_manager+0x748>
ffffffffc0202e3e:	00002617          	auipc	a2,0x2
ffffffffc0202e42:	a2a60613          	addi	a2,a2,-1494 # ffffffffc0204868 <commands+0x808>
ffffffffc0202e46:	08600593          	li	a1,134
ffffffffc0202e4a:	00002517          	auipc	a0,0x2
ffffffffc0202e4e:	4e650513          	addi	a0,a0,1254 # ffffffffc0205330 <default_pmm_manager+0x718>
...
ffffffffc0202eb4:	66868693          	addi	a3,a3,1640 # ffffffffc0205518 <default_pmm_manager+0x900>
ffffffffc0202eb8:	00002617          	auipc	a2,0x2
ffffffffc0202ebc:	9b060613          	addi	a2,a2,-1616 # ffffffffc0204868 <commands+0x808>
ffffffffc0202ec0:	0da00593          	li	a1,218
ffffffffc0202ec4:	00002517          	auipc	a0,0x2
ffffffffc0202ec8:	46c50513          	addi	a0,a0,1132 # ffffffffc0205330 <default_pmm_manager+0x718>
...
ffffffffc0202f02:	61a68693          	addi	a3,a3,1562 # ffffffffc0205518 <default_pmm_manager+0x900>
ffffffffc0202f06:	00002617          	auipc	a2,0x2
ffffffffc0202f0a:	96260613          	addi	a2,a2,-1694 # ffffffffc0204868 <commands+0x808>
ffffffffc0202f0e:	0e100593          	li	a1,225
ffffffffc0202f12:	00002517          	auipc	a0,0x2
ffffffffc0202f16:	41e50513          	addi	a0,a0,1054 # ffffffffc0205330 <default_pmm_manager+0x718>
...
ffffffffc0202fd6:	4ce50513          	addi	a0,a0,1230 # ffffffffc02054a0 <default_pmm_manager+0x888>
ffffffffc0202fda:	9bafd0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0202fde:	00002697          	auipc	a3,0x2
ffffffffc0202fe2:	4ea68693          	addi	a3,a3,1258 # ffffffffc02054c8 <default_pmm_manager+0x8b0>
ffffffffc0202fe6:	00002617          	auipc	a2,0x2
ffffffffc0202fea:	88260613          	addi	a2,a2,-1918 # ffffffffc0204868 <commands+0x808>
ffffffffc0202fee:	10700593          	li	a1,263
ffffffffc0202ff2:	00002517          	auipc	a0,0x2
ffffffffc0202ff6:	33e50513          	addi	a0,a0,830 # ffffffffc0205330 <default_pmm_manager+0x718>
...
ffffffffc0203028:	4bc50513          	addi	a0,a0,1212 # ffffffffc02054e0 <default_pmm_manager+0x8c8>
...
ffffffffc0203042:	4c250513          	addi	a0,a0,1218 # ffffffffc0205500 <default_pmm_manager+0x8e8>
}
...
ffffffffc0203050:	36c68693          	addi	a3,a3,876 # ffffffffc02053b8 <default_pmm_manager+0x7a0>
ffffffffc0203054:	00002617          	auipc	a2,0x2
ffffffffc0203058:	81460613          	addi	a2,a2,-2028 # ffffffffc0204868 <commands+0x808>
ffffffffc020305c:	0eb00593          	li	a1,235
ffffffffc0203060:	00002517          	auipc	a0,0x2
ffffffffc0203064:	2d050513          	addi	a0,a0,720 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0203068:	bf2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc020306c:	00002697          	auipc	a3,0x2
ffffffffc0203070:	3d468693          	addi	a3,a3,980 # ffffffffc0205440 <default_pmm_manager+0x828>
ffffffffc0203074:	00001617          	auipc	a2,0x1
ffffffffc0203078:	7f460613          	addi	a2,a2,2036 # ffffffffc0204868 <commands+0x808>
ffffffffc020307c:	0fc00593          	li	a1,252
ffffffffc0203080:	00002517          	auipc	a0,0x2
ffffffffc0203084:	2b050513          	addi	a0,a0,688 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0203088:	bd2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc020308c:	00002697          	auipc	a3,0x2
ffffffffc0203090:	3e468693          	addi	a3,a3,996 # ffffffffc0205470 <default_pmm_manager+0x858>
ffffffffc0203094:	00001617          	auipc	a2,0x1
ffffffffc0203098:	7d460613          	addi	a2,a2,2004 # ffffffffc0204868 <commands+0x808>
ffffffffc020309c:	0fd00593          	li	a1,253
ffffffffc02030a0:	00002517          	auipc	a0,0x2
ffffffffc02030a4:	29050513          	addi	a0,a0,656 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc02030a8:	bb2fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc02030ac:	00002697          	auipc	a3,0x2
ffffffffc02030b0:	2f468693          	addi	a3,a3,756 # ffffffffc02053a0 <default_pmm_manager+0x788>
ffffffffc02030b4:	00001617          	auipc	a2,0x1
ffffffffc02030b8:	7b460613          	addi	a2,a2,1972 # ffffffffc0204868 <commands+0x808>
ffffffffc02030bc:	0e900593          	li	a1,233
ffffffffc02030c0:	00002517          	auipc	a0,0x2
ffffffffc02030c4:	27050513          	addi	a0,a0,624 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc02030c8:	b92fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2 != NULL);
ffffffffc02030cc:	00002697          	auipc	a3,0x2
ffffffffc02030d0:	33468693          	addi	a3,a3,820 # ffffffffc0205400 <default_pmm_manager+0x7e8>
ffffffffc02030d4:	00001617          	auipc	a2,0x1
ffffffffc02030d8:	79460613          	addi	a2,a2,1940 # ffffffffc0204868 <commands+0x808>
ffffffffc02030dc:	0f400593          	li	a1,244
ffffffffc02030e0:	00002517          	auipc	a0,0x2
ffffffffc02030e4:	25050513          	addi	a0,a0,592 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc02030e8:	b72fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1 != NULL);
ffffffffc02030ec:	00002697          	auipc	a3,0x2
ffffffffc02030f0:	30468693          	addi	a3,a3,772 # ffffffffc02053f0 <default_pmm_manager+0x7d8>
ffffffffc02030f4:	00001617          	auipc	a2,0x1
ffffffffc02030f8:	77460613          	addi	a2,a2,1908 # ffffffffc0204868 <commands+0x808>
ffffffffc02030fc:	0f200593          	li	a1,242
ffffffffc0203100:	00002517          	auipc	a0,0x2
ffffffffc0203104:	23050513          	addi	a0,a0,560 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0203108:	b52fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma3 == NULL);
ffffffffc020310c:	00002697          	auipc	a3,0x2
ffffffffc0203110:	30468693          	addi	a3,a3,772 # ffffffffc0205410 <default_pmm_manager+0x7f8>
ffffffffc0203114:	00001617          	auipc	a2,0x1
ffffffffc0203118:	75460613          	addi	a2,a2,1876 # ffffffffc0204868 <commands+0x808>
ffffffffc020311c:	0f600593          	li	a1,246
ffffffffc0203120:	00002517          	auipc	a0,0x2
ffffffffc0203124:	21050513          	addi	a0,a0,528 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0203128:	b32fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma5 == NULL);
ffffffffc020312c:	00002697          	auipc	a3,0x2
ffffffffc0203130:	30468693          	addi	a3,a3,772 # ffffffffc0205430 <default_pmm_manager+0x818>
ffffffffc0203134:	00001617          	auipc	a2,0x1
ffffffffc0203138:	73460613          	addi	a2,a2,1844 # ffffffffc0204868 <commands+0x808>
ffffffffc020313c:	0fa00593          	li	a1,250
ffffffffc0203140:	00002517          	auipc	a0,0x2
ffffffffc0203144:	1f050513          	addi	a0,a0,496 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0203148:	b12fd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma4 == NULL);
ffffffffc020314c:	00002697          	auipc	a3,0x2
ffffffffc0203150:	2d468693          	addi	a3,a3,724 # ffffffffc0205420 <default_pmm_manager+0x808>
ffffffffc0203154:	00001617          	auipc	a2,0x1
ffffffffc0203158:	71460613          	addi	a2,a2,1812 # ffffffffc0204868 <commands+0x808>
ffffffffc020315c:	0f800593          	li	a1,248
ffffffffc0203160:	00002517          	auipc	a0,0x2
ffffffffc0203164:	1d050513          	addi	a0,a0,464 # ffffffffc0205330 <default_pmm_manager+0x718>
ffffffffc0203168:	af2fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(mm != NULL);
ffffffffc020316c:	00002697          	auipc	a3,0x2
ffffffffc0203170:	3bc68693          	addi	a3,a3,956 # ffffffffc0205528 <default_pmm_manager+0x910>
ffffffffc0203174:	00001617          	auipc	a2,0x1
ffffffffc0203178:	6f460613          	addi	a2,a2,1780 # ffffffffc0204868 <commands+0x808>
ffffffffc020317c:	0d200593          	li	a1,210
ffffffffc0203180:	00002517          	auipc	a0,0x2
ffffffffc0203184:	1b050513          	addi	a0,a0,432 # ffffffffc0205330 <default_pmm_manager+0x718>
...
ffffffffc020318e:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203190:	3ee000ef          	jal	ra,ffffffffc020357e <do_exit>
...
ffffffffc02031a2:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc02031a4:	cd21                	beqz	a0,ffffffffc02031fc <alloc_proc+0x68>
...
ffffffffc02031ca:	3df000ef          	jal	ra,ffffffffc0203da8 <memset>
        proc->tf = NULL;            // 陷阱帧初始化为空
        proc->pgdir = boot_pgdir_pa;            // 页目录初始化为0
ffffffffc02031ce:	0000a797          	auipc	a5,0xa
ffffffffc02031d2:	2ca7b783          	ld	a5,714(a5) # ffffffffc020d498 <boot_pgdir_pa>
ffffffffc02031d6:	f45c                	sd	a5,168(s0)
        proc->tf = NULL;            // 陷阱帧初始化为空
ffffffffc02031d8:	0a043023          	sd	zero,160(s0)
        proc->flags = 0;            // 标志位清零
...
ffffffffc02031e8:	3c1000ef          	jal	ra,ffffffffc0203da8 <memset>
        list_init(&proc->list_link); // 初始化进程链表项
ffffffffc02031ec:	0c840713          	addi	a4,s0,200
        list_init(&proc->hash_link); // 初始化哈希链表项
ffffffffc02031f0:	0d840793          	addi	a5,s0,216
    elm->prev = elm->next = elm;
ffffffffc02031f4:	e878                	sd	a4,208(s0)
ffffffffc02031f6:	e478                	sd	a4,200(s0)
ffffffffc02031f8:	f07c                	sd	a5,224(s0)
ffffffffc02031fa:	ec7c                	sd	a5,216(s0)
...
ffffffffc0203200:	6402                	ld	s0,0(sp)
ffffffffc0203202:	0141                	addi	sp,sp,16
ffffffffc0203204:	8082                	ret

ffffffffc0203206 <forkret>:
...
{
    forkrets(current->tf);
ffffffffc0203206:	0000a797          	auipc	a5,0xa
ffffffffc020320a:	2c27b783          	ld	a5,706(a5) # ffffffffc020d4c8 <current>
ffffffffc020320e:	73c8                	ld	a0,160(a5)
ffffffffc0203210:	b4dfd06f          	j	ffffffffc0200d5c <forkrets>

ffffffffc0203214 <init_main>:
}
...
init_main(void *arg)
{
ffffffffc0203214:	7179                	addi	sp,sp,-48
ffffffffc0203216:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0203218:	0000a497          	auipc	s1,0xa
ffffffffc020321c:	23048493          	addi	s1,s1,560 # ffffffffc020d448 <name.2>
{
ffffffffc0203220:	f022                	sd	s0,32(sp)
ffffffffc0203222:	e84a                	sd	s2,16(sp)
ffffffffc0203224:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0203226:	0000a917          	auipc	s2,0xa
ffffffffc020322a:	2a293903          	ld	s2,674(s2) # ffffffffc020d4c8 <current>
    memset(name, 0, sizeof(name));
ffffffffc020322e:	4641                	li	a2,16
ffffffffc0203230:	4581                	li	a1,0
ffffffffc0203232:	8526                	mv	a0,s1
{
ffffffffc0203234:	f406                	sd	ra,40(sp)
ffffffffc0203236:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc0203238:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc020323c:	36d000ef          	jal	ra,ffffffffc0203da8 <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0203240:	0b490593          	addi	a1,s2,180
ffffffffc0203244:	463d                	li	a2,15
ffffffffc0203246:	8526                	mv	a0,s1
ffffffffc0203248:	373000ef          	jal	ra,ffffffffc0203dba <memcpy>
ffffffffc020324c:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020324e:	85ce                	mv	a1,s3
ffffffffc0203250:	00002517          	auipc	a0,0x2
ffffffffc0203254:	2e850513          	addi	a0,a0,744 # ffffffffc0205538 <default_pmm_manager+0x920>
ffffffffc0203258:	f3dfc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc020325c:	85a2                	mv	a1,s0
ffffffffc020325e:	00002517          	auipc	a0,0x2
ffffffffc0203262:	30250513          	addi	a0,a0,770 # ffffffffc0205560 <default_pmm_manager+0x948>
ffffffffc0203266:	f2ffc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc020326a:	00002517          	auipc	a0,0x2
ffffffffc020326e:	30650513          	addi	a0,a0,774 # ffffffffc0205570 <default_pmm_manager+0x958>
ffffffffc0203272:	f23fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    return 0;
}
ffffffffc0203276:	70a2                	ld	ra,40(sp)
ffffffffc0203278:	7402                	ld	s0,32(sp)
ffffffffc020327a:	64e2                	ld	s1,24(sp)
ffffffffc020327c:	6942                	ld	s2,16(sp)
ffffffffc020327e:	69a2                	ld	s3,8(sp)
ffffffffc0203280:	4501                	li	a0,0
ffffffffc0203282:	6145                	addi	sp,sp,48
ffffffffc0203284:	8082                	ret

ffffffffc0203286 <proc_run>:
{
ffffffffc0203286:	7179                	addi	sp,sp,-48
ffffffffc0203288:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc020328a:	0000a917          	auipc	s2,0xa
ffffffffc020328e:	23e90913          	addi	s2,s2,574 # ffffffffc020d4c8 <current>
{
ffffffffc0203292:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc0203294:	00093483          	ld	s1,0(s2)
{
ffffffffc0203298:	f406                	sd	ra,40(sp)
ffffffffc020329a:	e84e                	sd	s3,16(sp)
    if (proc != current)
ffffffffc020329c:	02a48963          	beq	s1,a0,ffffffffc02032ce <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02032a0:	100027f3          	csrr	a5,sstatus
ffffffffc02032a4:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02032a6:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02032a8:	e3a1                	bnez	a5,ffffffffc02032e8 <proc_run+0x62>
        lsatp(proc->pgdir);
ffffffffc02032aa:	755c                	ld	a5,168(a0)
...
ffffffffc02032ac:	80000737          	lui	a4,0x80000
        current = proc;
ffffffffc02032b0:	00a93023          	sd	a0,0(s2)
ffffffffc02032b4:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc02032b8:	8fd9                	or	a5,a5,a4
ffffffffc02032ba:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(proc->context));
ffffffffc02032be:	03050593          	addi	a1,a0,48
ffffffffc02032c2:	03048513          	addi	a0,s1,48
ffffffffc02032c6:	53e000ef          	jal	ra,ffffffffc0203804 <switch_to>
    if (flag) {
ffffffffc02032ca:	00099863          	bnez	s3,ffffffffc02032da <proc_run+0x54>
}
ffffffffc02032ce:	70a2                	ld	ra,40(sp)
ffffffffc02032d0:	7482                	ld	s1,32(sp)
ffffffffc02032d2:	6962                	ld	s2,24(sp)
ffffffffc02032d4:	69c2                	ld	s3,16(sp)
ffffffffc02032d6:	6145                	addi	sp,sp,48
ffffffffc02032d8:	8082                	ret
ffffffffc02032da:	70a2                	ld	ra,40(sp)
ffffffffc02032dc:	7482                	ld	s1,32(sp)
ffffffffc02032de:	6962                	ld	s2,24(sp)
ffffffffc02032e0:	69c2                	ld	s3,16(sp)
ffffffffc02032e2:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc02032e4:	e2cfd06f          	j	ffffffffc0200910 <intr_enable>
ffffffffc02032e8:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc02032ea:	e2cfd0ef          	jal	ra,ffffffffc0200916 <intr_disable>
        return 1;
ffffffffc02032ee:	6522                	ld	a0,8(sp)
ffffffffc02032f0:	4985                	li	s3,1
ffffffffc02032f2:	bf65                	j	ffffffffc02032aa <proc_run+0x24>

ffffffffc02032f4 <do_fork>:
{
ffffffffc02032f4:	7179                	addi	sp,sp,-48
ffffffffc02032f6:	e44e                	sd	s3,8(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc02032f8:	0000a997          	auipc	s3,0xa
ffffffffc02032fc:	1e898993          	addi	s3,s3,488 # ffffffffc020d4e0 <nr_process>
ffffffffc0203300:	0009a703          	lw	a4,0(s3)
{
...
ffffffffc020330e:	1cf75d63          	bge	a4,a5,ffffffffc02034e8 <do_fork+0x1f4>
ffffffffc0203312:	84ae                	mv	s1,a1
ffffffffc0203314:	8432                	mv	s0,a2
     if ((proc = alloc_proc()) == NULL)
ffffffffc0203316:	e7fff0ef          	jal	ra,ffffffffc0203194 <alloc_proc>
ffffffffc020331a:	892a                	mv	s2,a0
ffffffffc020331c:	1c050b63          	beqz	a0,ffffffffc02034f2 <do_fork+0x1fe>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203320:	4509                	li	a0,2
ffffffffc0203322:	8fbfe0ef          	jal	ra,ffffffffc0201c1c <alloc_pages>
    if (page != NULL)
ffffffffc0203326:	1a050c63          	beqz	a0,ffffffffc02034de <do_fork+0x1ea>
    return page - pages + nbase;
...
ffffffffc020333c:	5a053503          	ld	a0,1440(a0) # ffffffffc02058d8 <nbase>
...
ffffffffc0203350:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0203352:	1ce7f263          	bgeu	a5,a4,ffffffffc0203516 <do_fork+0x222>
    assert(current->mm == NULL);
ffffffffc0203356:	0000a317          	auipc	t1,0xa
ffffffffc020335a:	17233303          	ld	t1,370(t1) # ffffffffc020d4c8 <current>
ffffffffc020335e:	02833783          	ld	a5,40(t1)
ffffffffc0203362:	0000a717          	auipc	a4,0xa
ffffffffc0203366:	15e73703          	ld	a4,350(a4) # ffffffffc020d4c0 <va_pa_offset>
ffffffffc020336a:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020336c:	00d93823          	sd	a3,16(s2)
    assert(current->mm == NULL);
ffffffffc0203370:	18079363          	bnez	a5,ffffffffc02034f6 <do_fork+0x202>
...
ffffffffc020337a:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc020337c:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc020337e:	0ad93023          	sd	a3,160(s2)
    *(proc->tf) = *tf;
ffffffffc0203382:	87b6                	mv	a5,a3
ffffffffc0203384:	12040893          	addi	a7,s0,288
ffffffffc0203388:	00063803          	ld	a6,0(a2)
ffffffffc020338c:	6608                	ld	a0,8(a2)
ffffffffc020338e:	6a0c                	ld	a1,16(a2)
ffffffffc0203390:	6e18                	ld	a4,24(a2)
ffffffffc0203392:	0107b023          	sd	a6,0(a5)
ffffffffc0203396:	e788                	sd	a0,8(a5)
ffffffffc0203398:	eb8c                	sd	a1,16(a5)
ffffffffc020339a:	ef98                	sd	a4,24(a5)
ffffffffc020339c:	02060613          	addi	a2,a2,32
ffffffffc02033a0:	02078793          	addi	a5,a5,32
ffffffffc02033a4:	ff1612e3          	bne	a2,a7,ffffffffc0203388 <do_fork+0x94>
    proc->tf->gpr.a0 = 0;
ffffffffc02033a8:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02033ac:	10048c63          	beqz	s1,ffffffffc02034c4 <do_fork+0x1d0>
    if (++last_pid >= MAX_PID)
ffffffffc02033b0:	00006e17          	auipc	t3,0x6
ffffffffc02033b4:	c78e0e13          	addi	t3,t3,-904 # ffffffffc0209028 <last_pid.1>
ffffffffc02033b8:	000e2783          	lw	a5,0(t3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02033bc:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02033be:	00000717          	auipc	a4,0x0
ffffffffc02033c2:	e4870713          	addi	a4,a4,-440 # ffffffffc0203206 <forkret>
    if (++last_pid >= MAX_PID)
ffffffffc02033c6:	0017851b          	addiw	a0,a5,1
    return listelm->next;
ffffffffc02033ca:	0000a617          	auipc	a2,0xa
ffffffffc02033ce:	08e60613          	addi	a2,a2,142 # ffffffffc020d458 <proc_list>
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02033d2:	02e93823          	sd	a4,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02033d6:	02d93c23          	sd	a3,56(s2)
    if (++last_pid >= MAX_PID)
ffffffffc02033da:	00ae2023          	sw	a0,0(t3)
ffffffffc02033de:	6789                	lui	a5,0x2
ffffffffc02033e0:	00863883          	ld	a7,8(a2)
ffffffffc02033e4:	06f55e63          	bge	a0,a5,ffffffffc0203460 <do_fork+0x16c>
    if (last_pid >= next_safe)
ffffffffc02033e8:	00006f17          	auipc	t5,0x6
ffffffffc02033ec:	c44f0f13          	addi	t5,t5,-956 # ffffffffc020902c <next_safe.0>
ffffffffc02033f0:	000f2783          	lw	a5,0(t5)
ffffffffc02033f4:	06f55e63          	bge	a0,a5,ffffffffc0203470 <do_fork+0x17c>
    nr_process++;
ffffffffc02033f8:	0009a783          	lw	a5,0(s3)
    proc->pid = get_pid();
ffffffffc02033fc:	00a92223          	sw	a0,4(s2)
    list_add(&proc_list, &proc->list_link);
ffffffffc0203400:	0c890713          	addi	a4,s2,200
    proc->parent = current;
ffffffffc0203404:	02693023          	sd	t1,32(s2)
    prev->next = next->prev = elm;
ffffffffc0203408:	00e8b023          	sd	a4,0(a7)
    nr_process++;
ffffffffc020340c:	2785                	addiw	a5,a5,1
    elm->next = next;
ffffffffc020340e:	0d193823          	sd	a7,208(s2)
    elm->prev = prev;
ffffffffc0203412:	0cc93423          	sd	a2,200(s2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203416:	45a9                	li	a1,10
ffffffffc0203418:	2501                	sext.w	a0,a0
    nr_process++;
ffffffffc020341a:	00f9a023          	sw	a5,0(s3)
    prev->next = next->prev = elm;
ffffffffc020341e:	e618                	sd	a4,8(a2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203420:	4e2000ef          	jal	ra,ffffffffc0203902 <hash32>
ffffffffc0203424:	02051713          	slli	a4,a0,0x20
ffffffffc0203428:	01c75793          	srli	a5,a4,0x1c
ffffffffc020342c:	00006517          	auipc	a0,0x6
ffffffffc0203430:	01c50513          	addi	a0,a0,28 # ffffffffc0209448 <hash_list>
ffffffffc0203434:	97aa                	add	a5,a5,a0
    __list_add(elm, listelm, listelm->next);
ffffffffc0203436:	6798                	ld	a4,8(a5)
ffffffffc0203438:	0d890693          	addi	a3,s2,216
    ret = proc->pid;
ffffffffc020343c:	00492503          	lw	a0,4(s2)
    prev->next = next->prev = elm;
ffffffffc0203440:	e314                	sd	a3,0(a4)
ffffffffc0203442:	e794                	sd	a3,8(a5)
    elm->prev = prev;
ffffffffc0203444:	0cf93c23          	sd	a5,216(s2)
    proc->state = PROC_RUNNABLE;
ffffffffc0203448:	4789                	li	a5,2
    elm->next = next;
ffffffffc020344a:	0ee93023          	sd	a4,224(s2)
ffffffffc020344e:	00f92023          	sw	a5,0(s2)
}
ffffffffc0203452:	70a2                	ld	ra,40(sp)
ffffffffc0203454:	7402                	ld	s0,32(sp)
ffffffffc0203456:	64e2                	ld	s1,24(sp)
ffffffffc0203458:	6942                	ld	s2,16(sp)
ffffffffc020345a:	69a2                	ld	s3,8(sp)
ffffffffc020345c:	6145                	addi	sp,sp,48
ffffffffc020345e:	8082                	ret
        last_pid = 1;
ffffffffc0203460:	4785                	li	a5,1
ffffffffc0203462:	00fe2023          	sw	a5,0(t3)
        goto inside;
ffffffffc0203466:	4505                	li	a0,1
ffffffffc0203468:	00006f17          	auipc	t5,0x6
ffffffffc020346c:	bc4f0f13          	addi	t5,t5,-1084 # ffffffffc020902c <next_safe.0>
        next_safe = MAX_PID;
ffffffffc0203470:	6789                	lui	a5,0x2
ffffffffc0203472:	00ff2023          	sw	a5,0(t5)
ffffffffc0203476:	86aa                	mv	a3,a0
ffffffffc0203478:	4801                	li	a6,0
        while ((le = list_next(le)) != list)
ffffffffc020347a:	6f89                	lui	t6,0x2
ffffffffc020347c:	04c88b63          	beq	a7,a2,ffffffffc02034d2 <do_fork+0x1de>
ffffffffc0203480:	8ec2                	mv	t4,a6
ffffffffc0203482:	87c6                	mv	a5,a7
ffffffffc0203484:	6589                	lui	a1,0x2
ffffffffc0203486:	a811                	j	ffffffffc020349a <do_fork+0x1a6>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc0203488:	00e6d663          	bge	a3,a4,ffffffffc0203494 <do_fork+0x1a0>
ffffffffc020348c:	00b75463          	bge	a4,a1,ffffffffc0203494 <do_fork+0x1a0>
ffffffffc0203490:	85ba                	mv	a1,a4
ffffffffc0203492:	4e85                	li	t4,1
    return listelm->next;
ffffffffc0203494:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203496:	00c78d63          	beq	a5,a2,ffffffffc02034b0 <do_fork+0x1bc>
            if (proc->pid == last_pid)
ffffffffc020349a:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020349e:	fed715e3          	bne	a4,a3,ffffffffc0203488 <do_fork+0x194>
                if (++last_pid >= next_safe)
ffffffffc02034a2:	2685                	addiw	a3,a3,1
ffffffffc02034a4:	02b6d263          	bge	a3,a1,ffffffffc02034c8 <do_fork+0x1d4>
ffffffffc02034a8:	679c                	ld	a5,8(a5)
ffffffffc02034aa:	4805                	li	a6,1
        while ((le = list_next(le)) != list)
ffffffffc02034ac:	fec797e3          	bne	a5,a2,ffffffffc020349a <do_fork+0x1a6>
ffffffffc02034b0:	00080563          	beqz	a6,ffffffffc02034ba <do_fork+0x1c6>
ffffffffc02034b4:	00de2023          	sw	a3,0(t3)
ffffffffc02034b8:	8536                	mv	a0,a3
ffffffffc02034ba:	f20e8fe3          	beqz	t4,ffffffffc02033f8 <do_fork+0x104>
ffffffffc02034be:	00bf2023          	sw	a1,0(t5)
ffffffffc02034c2:	bf1d                	j	ffffffffc02033f8 <do_fork+0x104>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02034c4:	84b6                	mv	s1,a3
ffffffffc02034c6:	b5ed                	j	ffffffffc02033b0 <do_fork+0xbc>
                    if (last_pid >= MAX_PID)
ffffffffc02034c8:	01f6c363          	blt	a3,t6,ffffffffc02034ce <do_fork+0x1da>
                        last_pid = 1;
ffffffffc02034cc:	4685                	li	a3,1
                    goto repeat;
ffffffffc02034ce:	4805                	li	a6,1
ffffffffc02034d0:	b775                	j	ffffffffc020347c <do_fork+0x188>
ffffffffc02034d2:	00080d63          	beqz	a6,ffffffffc02034ec <do_fork+0x1f8>
ffffffffc02034d6:	00de2023          	sw	a3,0(t3)
    return last_pid;
ffffffffc02034da:	8536                	mv	a0,a3
ffffffffc02034dc:	bf31                	j	ffffffffc02033f8 <do_fork+0x104>
    kfree(proc);
ffffffffc02034de:	854a                	mv	a0,s2
ffffffffc02034e0:	e0efe0ef          	jal	ra,ffffffffc0201aee <kfree>
    ret = -E_NO_MEM;
ffffffffc02034e4:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02034e6:	b7b5                	j	ffffffffc0203452 <do_fork+0x15e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02034e8:	556d                	li	a0,-5
ffffffffc02034ea:	b7a5                	j	ffffffffc0203452 <do_fork+0x15e>
    return last_pid;
ffffffffc02034ec:	000e2503          	lw	a0,0(t3)
ffffffffc02034f0:	b721                	j	ffffffffc02033f8 <do_fork+0x104>
    ret = -E_NO_MEM;
ffffffffc02034f2:	5571                	li	a0,-4
    return ret;
ffffffffc02034f4:	bfb9                	j	ffffffffc0203452 <do_fork+0x15e>
    assert(current->mm == NULL);
ffffffffc02034f6:	00002697          	auipc	a3,0x2
ffffffffc02034fa:	09a68693          	addi	a3,a3,154 # ffffffffc0205590 <default_pmm_manager+0x978>
ffffffffc02034fe:	00001617          	auipc	a2,0x1
ffffffffc0203502:	36a60613          	addi	a2,a2,874 # ffffffffc0204868 <commands+0x808>
ffffffffc0203506:	11f00593          	li	a1,287
ffffffffc020350a:	00002517          	auipc	a0,0x2
ffffffffc020350e:	09e50513          	addi	a0,a0,158 # ffffffffc02055a8 <default_pmm_manager+0x990>
ffffffffc0203512:	f49fc0ef          	jal	ra,ffffffffc020045a <__panic>
ffffffffc0203516:	00001617          	auipc	a2,0x1
ffffffffc020351a:	73a60613          	addi	a2,a2,1850 # ffffffffc0204c50 <default_pmm_manager+0x38>
ffffffffc020351e:	07100593          	li	a1,113
ffffffffc0203522:	00001517          	auipc	a0,0x1
ffffffffc0203526:	75650513          	addi	a0,a0,1878 # ffffffffc0204c78 <default_pmm_manager+0x60>
ffffffffc020352a:	f31fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020352e <kernel_thread>:
{
ffffffffc020352e:	7129                	addi	sp,sp,-320
ffffffffc0203530:	fa22                	sd	s0,304(sp)
ffffffffc0203532:	f626                	sd	s1,296(sp)
ffffffffc0203534:	f24a                	sd	s2,288(sp)
ffffffffc0203536:	84ae                	mv	s1,a1
ffffffffc0203538:	892a                	mv	s2,a0
ffffffffc020353a:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020353c:	4581                	li	a1,0
ffffffffc020353e:	12000613          	li	a2,288
ffffffffc0203542:	850a                	mv	a0,sp
{
ffffffffc0203544:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0203546:	063000ef          	jal	ra,ffffffffc0203da8 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc020354a:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc020354c:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020354e:	100027f3          	csrr	a5,sstatus
ffffffffc0203552:	edd7f793          	andi	a5,a5,-291
ffffffffc0203556:	1207e793          	ori	a5,a5,288
ffffffffc020355a:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020355c:	860a                	mv	a2,sp
ffffffffc020355e:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0203562:	00000797          	auipc	a5,0x0
ffffffffc0203566:	c2a78793          	addi	a5,a5,-982 # ffffffffc020318c <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020356a:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020356c:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020356e:	d87ff0ef          	jal	ra,ffffffffc02032f4 <do_fork>
}
ffffffffc0203572:	70f2                	ld	ra,312(sp)
ffffffffc0203574:	7452                	ld	s0,304(sp)
ffffffffc0203576:	74b2                	ld	s1,296(sp)
ffffffffc0203578:	7912                	ld	s2,288(sp)
ffffffffc020357a:	6131                	addi	sp,sp,320
ffffffffc020357c:	8082                	ret

ffffffffc020357e <do_exit>:
{
ffffffffc020357e:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0203580:	00002617          	auipc	a2,0x2
ffffffffc0203584:	04060613          	addi	a2,a2,64 # ffffffffc02055c0 <default_pmm_manager+0x9a8>
ffffffffc0203588:	18600593          	li	a1,390
ffffffffc020358c:	00002517          	auipc	a0,0x2
ffffffffc0203590:	01c50513          	addi	a0,a0,28 # ffffffffc02055a8 <default_pmm_manager+0x990>
{
ffffffffc0203594:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0203596:	ec5fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020359a <proc_init>:
...
ffffffffc020359c:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc020359e:	0000a797          	auipc	a5,0xa
ffffffffc02035a2:	eba78793          	addi	a5,a5,-326 # ffffffffc020d458 <proc_list>
ffffffffc02035a6:	f406                	sd	ra,40(sp)
ffffffffc02035a8:	f022                	sd	s0,32(sp)
ffffffffc02035aa:	e84a                	sd	s2,16(sp)
ffffffffc02035ac:	e44e                	sd	s3,8(sp)
ffffffffc02035ae:	00006497          	auipc	s1,0x6
ffffffffc02035b2:	e9a48493          	addi	s1,s1,-358 # ffffffffc0209448 <hash_list>
ffffffffc02035b6:	e79c                	sd	a5,8(a5)
ffffffffc02035b8:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc02035ba:	0000a717          	auipc	a4,0xa
ffffffffc02035be:	e8e70713          	addi	a4,a4,-370 # ffffffffc020d448 <name.2>
ffffffffc02035c2:	87a6                	mv	a5,s1
ffffffffc02035c4:	e79c                	sd	a5,8(a5)
ffffffffc02035c6:	e39c                	sd	a5,0(a5)
ffffffffc02035c8:	07c1                	addi	a5,a5,16
ffffffffc02035ca:	fef71de3          	bne	a4,a5,ffffffffc02035c4 <proc_init+0x2a>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc02035ce:	bc7ff0ef          	jal	ra,ffffffffc0203194 <alloc_proc>
ffffffffc02035d2:	0000a917          	auipc	s2,0xa
ffffffffc02035d6:	efe90913          	addi	s2,s2,-258 # ffffffffc020d4d0 <idleproc>
ffffffffc02035da:	00a93023          	sd	a0,0(s2)
ffffffffc02035de:	18050d63          	beqz	a0,ffffffffc0203778 <proc_init+0x1de>
    {
...
ffffffffc02035e2:	07000513          	li	a0,112
ffffffffc02035e6:	c58fe0ef          	jal	ra,ffffffffc0201a3e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02035ea:	07000613          	li	a2,112
ffffffffc02035ee:	4581                	li	a1,0
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc02035f0:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02035f2:	7b6000ef          	jal	ra,ffffffffc0203da8 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02035f6:	00093503          	ld	a0,0(s2)
ffffffffc02035fa:	85a2                	mv	a1,s0
ffffffffc02035fc:	07000613          	li	a2,112
ffffffffc0203600:	03050513          	addi	a0,a0,48
ffffffffc0203604:	7ce000ef          	jal	ra,ffffffffc0203dd2 <memcmp>
ffffffffc0203608:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc020360a:	453d                	li	a0,15
ffffffffc020360c:	c32fe0ef          	jal	ra,ffffffffc0201a3e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203610:	463d                	li	a2,15
ffffffffc0203612:	4581                	li	a1,0
    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203614:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203616:	792000ef          	jal	ra,ffffffffc0203da8 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc020361a:	00093503          	ld	a0,0(s2)
ffffffffc020361e:	463d                	li	a2,15
ffffffffc0203620:	85a2                	mv	a1,s0
ffffffffc0203622:	0b450513          	addi	a0,a0,180
ffffffffc0203626:	7ac000ef          	jal	ra,ffffffffc0203dd2 <memcmp>
...
ffffffffc020362a:	00093783          	ld	a5,0(s2)
ffffffffc020362e:	0000a717          	auipc	a4,0xa
ffffffffc0203632:	e6a73703          	ld	a4,-406(a4) # ffffffffc020d498 <boot_pgdir_pa>
ffffffffc0203636:	77d4                	ld	a3,168(a5)
ffffffffc0203638:	0ee68463          	beq	a3,a4,ffffffffc0203720 <proc_init+0x186>
    {
...
ffffffffc020363c:	4709                	li	a4,2
ffffffffc020363e:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0203640:	00003717          	auipc	a4,0x3
ffffffffc0203644:	9c070713          	addi	a4,a4,-1600 # ffffffffc0206000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203648:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020364c:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc020364e:	4705                	li	a4,1
ffffffffc0203650:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203652:	4641                	li	a2,16
ffffffffc0203654:	4581                	li	a1,0
ffffffffc0203656:	8522                	mv	a0,s0
ffffffffc0203658:	750000ef          	jal	ra,ffffffffc0203da8 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020365c:	463d                	li	a2,15
ffffffffc020365e:	00002597          	auipc	a1,0x2
ffffffffc0203662:	faa58593          	addi	a1,a1,-86 # ffffffffc0205608 <default_pmm_manager+0x9f0>
ffffffffc0203666:	8522                	mv	a0,s0
ffffffffc0203668:	752000ef          	jal	ra,ffffffffc0203dba <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc020366c:	0000a717          	auipc	a4,0xa
ffffffffc0203670:	e7470713          	addi	a4,a4,-396 # ffffffffc020d4e0 <nr_process>
ffffffffc0203674:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0203676:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020367a:	4601                	li	a2,0
    nr_process++;
ffffffffc020367c:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020367e:	00002597          	auipc	a1,0x2
ffffffffc0203682:	f9258593          	addi	a1,a1,-110 # ffffffffc0205610 <default_pmm_manager+0x9f8>
ffffffffc0203686:	00000517          	auipc	a0,0x0
ffffffffc020368a:	b8e50513          	addi	a0,a0,-1138 # ffffffffc0203214 <init_main>
    nr_process++;
ffffffffc020368e:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0203690:	0000a797          	auipc	a5,0xa
ffffffffc0203694:	e2d7bc23          	sd	a3,-456(a5) # ffffffffc020d4c8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0203698:	e97ff0ef          	jal	ra,ffffffffc020352e <kernel_thread>
ffffffffc020369c:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc020369e:	0ea05963          	blez	a0,ffffffffc0203790 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc02036a2:	6789                	lui	a5,0x2
ffffffffc02036a4:	fff5071b          	addiw	a4,a0,-1
ffffffffc02036a8:	17f9                	addi	a5,a5,-2
ffffffffc02036aa:	2501                	sext.w	a0,a0
ffffffffc02036ac:	02e7e363          	bltu	a5,a4,ffffffffc02036d2 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02036b0:	45a9                	li	a1,10
ffffffffc02036b2:	250000ef          	jal	ra,ffffffffc0203902 <hash32>
ffffffffc02036b6:	02051793          	slli	a5,a0,0x20
ffffffffc02036ba:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02036be:	96a6                	add	a3,a3,s1
ffffffffc02036c0:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc02036c2:	a029                	j	ffffffffc02036cc <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc02036c4:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc02036c8:	0a870563          	beq	a4,s0,ffffffffc0203772 <proc_init+0x1d8>
    return listelm->next;
ffffffffc02036cc:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc02036ce:	fef69be3          	bne	a3,a5,ffffffffc02036c4 <proc_init+0x12a>
    return NULL;
ffffffffc02036d2:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036d4:	0b478493          	addi	s1,a5,180
...
ffffffffc02036dc:	0000a417          	auipc	s0,0xa
ffffffffc02036e0:	dfc40413          	addi	s0,s0,-516 # ffffffffc020d4d8 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036e4:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02036e6:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036e8:	6c0000ef          	jal	ra,ffffffffc0203da8 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02036ec:	463d                	li	a2,15
ffffffffc02036ee:	00002597          	auipc	a1,0x2
ffffffffc02036f2:	f5258593          	addi	a1,a1,-174 # ffffffffc0205640 <default_pmm_manager+0xa28>
ffffffffc02036f6:	8526                	mv	a0,s1
ffffffffc02036f8:	6c2000ef          	jal	ra,ffffffffc0203dba <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02036fc:	00093783          	ld	a5,0(s2)
ffffffffc0203700:	c7e1                	beqz	a5,ffffffffc02037c8 <proc_init+0x22e>
ffffffffc0203702:	43dc                	lw	a5,4(a5)
ffffffffc0203704:	e3f1                	bnez	a5,ffffffffc02037c8 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203706:	601c                	ld	a5,0(s0)
ffffffffc0203708:	c3c5                	beqz	a5,ffffffffc02037a8 <proc_init+0x20e>
ffffffffc020370a:	43d8                	lw	a4,4(a5)
ffffffffc020370c:	4785                	li	a5,1
ffffffffc020370e:	08f71d63          	bne	a4,a5,ffffffffc02037a8 <proc_init+0x20e>
}
ffffffffc0203712:	70a2                	ld	ra,40(sp)
ffffffffc0203714:	7402                	ld	s0,32(sp)
ffffffffc0203716:	64e2                	ld	s1,24(sp)
ffffffffc0203718:	6942                	ld	s2,16(sp)
ffffffffc020371a:	69a2                	ld	s3,8(sp)
ffffffffc020371c:	6145                	addi	sp,sp,48
ffffffffc020371e:	8082                	ret
    if (idleproc->pgdir == boot_pgdir_pa && idleproc->tf == NULL && !context_init_flag && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0 && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag)
ffffffffc0203720:	73d8                	ld	a4,160(a5)
ffffffffc0203722:	ff09                	bnez	a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc0203724:	f0099ce3          	bnez	s3,ffffffffc020363c <proc_init+0xa2>
ffffffffc0203728:	6394                	ld	a3,0(a5)
ffffffffc020372a:	577d                	li	a4,-1
ffffffffc020372c:	1702                	slli	a4,a4,0x20
ffffffffc020372e:	f0e697e3          	bne	a3,a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc0203732:	4798                	lw	a4,8(a5)
ffffffffc0203734:	f00714e3          	bnez	a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc0203738:	6b98                	ld	a4,16(a5)
ffffffffc020373a:	f00711e3          	bnez	a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc020373e:	4f98                	lw	a4,24(a5)
ffffffffc0203740:	2701                	sext.w	a4,a4
ffffffffc0203742:	ee071de3          	bnez	a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc0203746:	7398                	ld	a4,32(a5)
ffffffffc0203748:	ee071ae3          	bnez	a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc020374c:	7798                	ld	a4,40(a5)
ffffffffc020374e:	ee0717e3          	bnez	a4,ffffffffc020363c <proc_init+0xa2>
ffffffffc0203752:	0b07a703          	lw	a4,176(a5)
ffffffffc0203756:	8d59                	or	a0,a0,a4
ffffffffc0203758:	0005071b          	sext.w	a4,a0
ffffffffc020375c:	ee0710e3          	bnez	a4,ffffffffc020363c <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0203760:	00002517          	auipc	a0,0x2
ffffffffc0203764:	e9050513          	addi	a0,a0,-368 # ffffffffc02055f0 <default_pmm_manager+0x9d8>
ffffffffc0203768:	a2dfc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;
ffffffffc020376c:	00093783          	ld	a5,0(s2)
ffffffffc0203770:	b5f1                	j	ffffffffc020363c <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0203772:	f2878793          	addi	a5,a5,-216
ffffffffc0203776:	bfb9                	j	ffffffffc02036d4 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc0203778:	00002617          	auipc	a2,0x2
ffffffffc020377c:	e6060613          	addi	a2,a2,-416 # ffffffffc02055d8 <default_pmm_manager+0x9c0>
ffffffffc0203780:	1a100593          	li	a1,417
ffffffffc0203784:	00002517          	auipc	a0,0x2
ffffffffc0203788:	e2450513          	addi	a0,a0,-476 # ffffffffc02055a8 <default_pmm_manager+0x990>
ffffffffc020378c:	ccffc0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("create init_main failed.\n");
ffffffffc0203790:	00002617          	auipc	a2,0x2
ffffffffc0203794:	e9060613          	addi	a2,a2,-368 # ffffffffc0205620 <default_pmm_manager+0xa08>
ffffffffc0203798:	1be00593          	li	a1,446
ffffffffc020379c:	00002517          	auipc	a0,0x2
ffffffffc02037a0:	e0c50513          	addi	a0,a0,-500 # ffffffffc02055a8 <default_pmm_manager+0x990>
ffffffffc02037a4:	cb7fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02037a8:	00002697          	auipc	a3,0x2
ffffffffc02037ac:	ec868693          	addi	a3,a3,-312 # ffffffffc0205670 <default_pmm_manager+0xa58>
ffffffffc02037b0:	00001617          	auipc	a2,0x1
ffffffffc02037b4:	0b860613          	addi	a2,a2,184 # ffffffffc0204868 <commands+0x808>
ffffffffc02037b8:	1c500593          	li	a1,453
ffffffffc02037bc:	00002517          	auipc	a0,0x2
ffffffffc02037c0:	dec50513          	addi	a0,a0,-532 # ffffffffc02055a8 <default_pmm_manager+0x990>
ffffffffc02037c4:	c97fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02037c8:	00002697          	auipc	a3,0x2
ffffffffc02037cc:	e8068693          	addi	a3,a3,-384 # ffffffffc0205648 <default_pmm_manager+0xa30>
ffffffffc02037d0:	00001617          	auipc	a2,0x1
ffffffffc02037d4:	09860613          	addi	a2,a2,152 # ffffffffc0204868 <commands+0x808>
ffffffffc02037d8:	1c400593          	li	a1,452
ffffffffc02037dc:	00002517          	auipc	a0,0x2
ffffffffc02037e0:	dcc50513          	addi	a0,a0,-564 # ffffffffc02055a8 <default_pmm_manager+0x990>
ffffffffc02037e4:	c77fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc02037e8 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void cpu_idle(void)
{
ffffffffc02037e8:	1141                	addi	sp,sp,-16
ffffffffc02037ea:	e022                	sd	s0,0(sp)
ffffffffc02037ec:	e406                	sd	ra,8(sp)
ffffffffc02037ee:	0000a417          	auipc	s0,0xa
ffffffffc02037f2:	cda40413          	addi	s0,s0,-806 # ffffffffc020d4c8 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc02037f6:	6018                	ld	a4,0(s0)
ffffffffc02037f8:	4f1c                	lw	a5,24(a4)
ffffffffc02037fa:	2781                	sext.w	a5,a5
ffffffffc02037fc:	dff5                	beqz	a5,ffffffffc02037f8 <cpu_idle+0x10>
        {
            schedule();
ffffffffc02037fe:	070000ef          	jal	ra,ffffffffc020386e <schedule>
ffffffffc0203802:	bfd5                	j	ffffffffc02037f6 <cpu_idle+0xe>

ffffffffc0203804 <switch_to>:
.text
...
ffffffffc0203804:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0203808:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020380c:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020380e:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0203810:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0203814:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0203818:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020381c:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0203820:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0203824:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0203828:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020382c:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0203830:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0203834:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0203838:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc020383c:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0203840:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0203842:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0203844:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0203848:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc020384c:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0203850:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0203854:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0203858:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020385c:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0203860:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0203864:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0203868:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc020386c:	8082                	ret

ffffffffc020386e <schedule>:
...
ffffffffc0203870:	e406                	sd	ra,8(sp)
ffffffffc0203872:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203874:	100027f3          	csrr	a5,sstatus
ffffffffc0203878:	8b89                	andi	a5,a5,2
ffffffffc020387a:	4401                	li	s0,0
ffffffffc020387c:	efbd                	bnez	a5,ffffffffc02038fa <schedule+0x8c>
    bool intr_flag;
...
ffffffffc020387e:	0000a897          	auipc	a7,0xa
ffffffffc0203882:	c4a8b883          	ld	a7,-950(a7) # ffffffffc020d4c8 <current>
ffffffffc0203886:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020388a:	0000a517          	auipc	a0,0xa
ffffffffc020388e:	c4653503          	ld	a0,-954(a0) # ffffffffc020d4d0 <idleproc>
ffffffffc0203892:	04a88e63          	beq	a7,a0,ffffffffc02038ee <schedule+0x80>
ffffffffc0203896:	0c888693          	addi	a3,a7,200
ffffffffc020389a:	0000a617          	auipc	a2,0xa
ffffffffc020389e:	bbe60613          	addi	a2,a2,-1090 # ffffffffc020d458 <proc_list>
        le = last;
ffffffffc02038a2:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02038a6:	4809                	li	a6,2
ffffffffc02038a8:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02038aa:	00c78863          	beq	a5,a2,ffffffffc02038ba <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02038ae:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02038b2:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02038b6:	03070163          	beq	a4,a6,ffffffffc02038d8 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02038ba:	fef697e3          	bne	a3,a5,ffffffffc02038a8 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02038be:	ed89                	bnez	a1,ffffffffc02038d8 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02038c0:	451c                	lw	a5,8(a0)
ffffffffc02038c2:	2785                	addiw	a5,a5,1
ffffffffc02038c4:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02038c6:	00a88463          	beq	a7,a0,ffffffffc02038ce <schedule+0x60>
            proc_run(next);
ffffffffc02038ca:	9bdff0ef          	jal	ra,ffffffffc0203286 <proc_run>
    if (flag) {
ffffffffc02038ce:	e819                	bnez	s0,ffffffffc02038e4 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc02038d0:	60a2                	ld	ra,8(sp)
ffffffffc02038d2:	6402                	ld	s0,0(sp)
ffffffffc02038d4:	0141                	addi	sp,sp,16
ffffffffc02038d6:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02038d8:	4198                	lw	a4,0(a1)
ffffffffc02038da:	4789                	li	a5,2
ffffffffc02038dc:	fef712e3          	bne	a4,a5,ffffffffc02038c0 <schedule+0x52>
ffffffffc02038e0:	852e                	mv	a0,a1
ffffffffc02038e2:	bff9                	j	ffffffffc02038c0 <schedule+0x52>
}
ffffffffc02038e4:	6402                	ld	s0,0(sp)
ffffffffc02038e6:	60a2                	ld	ra,8(sp)
ffffffffc02038e8:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02038ea:	826fd06f          	j	ffffffffc0200910 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02038ee:	0000a617          	auipc	a2,0xa
ffffffffc02038f2:	b6a60613          	addi	a2,a2,-1174 # ffffffffc020d458 <proc_list>
ffffffffc02038f6:	86b2                	mv	a3,a2
ffffffffc02038f8:	b76d                	j	ffffffffc02038a2 <schedule+0x34>
        intr_disable();
ffffffffc02038fa:	81cfd0ef          	jal	ra,ffffffffc0200916 <intr_disable>
        return 1;
ffffffffc02038fe:	4405                	li	s0,1
ffffffffc0203900:	bfbd                	j	ffffffffc020387e <schedule+0x10>

ffffffffc0203902 <hash32>:
 *
...
ffffffffc0203902:	9e3707b7          	lui	a5,0x9e370
ffffffffc0203906:	2785                	addiw	a5,a5,1
ffffffffc0203908:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc020390c:	02000793          	li	a5,32
ffffffffc0203910:	9f8d                	subw	a5,a5,a1
}
ffffffffc0203912:	00f5553b          	srlw	a0,a0,a5
ffffffffc0203916:	8082                	ret

ffffffffc0203918 <printnum>:
 * */
static void
...
ffffffffc0203918:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020391c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc020391e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203922:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203924:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203928:	f022                	sd	s0,32(sp)
ffffffffc020392a:	ec26                	sd	s1,24(sp)
ffffffffc020392c:	e84a                	sd	s2,16(sp)
ffffffffc020392e:	f406                	sd	ra,40(sp)
...
ffffffffc0203934:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203936:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc020393a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc020393c:	03067e63          	bgeu	a2,a6,ffffffffc0203978 <printnum+0x60>
ffffffffc0203940:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203942:	00805763          	blez	s0,ffffffffc0203950 <printnum+0x38>
ffffffffc0203946:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203948:	85ca                	mv	a1,s2
ffffffffc020394a:	854e                	mv	a0,s3
ffffffffc020394c:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc020394e:	fc65                	bnez	s0,ffffffffc0203946 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203950:	1a02                	slli	s4,s4,0x20
ffffffffc0203952:	00002797          	auipc	a5,0x2
ffffffffc0203956:	d4678793          	addi	a5,a5,-698 # ffffffffc0205698 <default_pmm_manager+0xa80>
ffffffffc020395a:	020a5a13          	srli	s4,s4,0x20
ffffffffc020395e:	9a3e                	add	s4,s4,a5
}
ffffffffc0203960:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203962:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203966:	70a2                	ld	ra,40(sp)
ffffffffc0203968:	69a2                	ld	s3,8(sp)
ffffffffc020396a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020396c:	85ca                	mv	a1,s2
ffffffffc020396e:	87a6                	mv	a5,s1
}
ffffffffc0203970:	6942                	ld	s2,16(sp)
ffffffffc0203972:	64e2                	ld	s1,24(sp)
ffffffffc0203974:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203976:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203978:	03065633          	divu	a2,a2,a6
ffffffffc020397c:	8722                	mv	a4,s0
ffffffffc020397e:	f9bff0ef          	jal	ra,ffffffffc0203918 <printnum>
ffffffffc0203982:	b7f9                	j	ffffffffc0203950 <printnum+0x38>

ffffffffc0203984 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203984:	7119                	addi	sp,sp,-128
ffffffffc0203986:	f4a6                	sd	s1,104(sp)
ffffffffc0203988:	f0ca                	sd	s2,96(sp)
ffffffffc020398a:	ecce                	sd	s3,88(sp)
ffffffffc020398c:	e8d2                	sd	s4,80(sp)
ffffffffc020398e:	e4d6                	sd	s5,72(sp)
ffffffffc0203990:	e0da                	sd	s6,64(sp)
ffffffffc0203992:	fc5e                	sd	s7,56(sp)
ffffffffc0203994:	f06a                	sd	s10,32(sp)
ffffffffc0203996:	fc86                	sd	ra,120(sp)
ffffffffc0203998:	f8a2                	sd	s0,112(sp)
ffffffffc020399a:	f862                	sd	s8,48(sp)
ffffffffc020399c:	f466                	sd	s9,40(sp)
ffffffffc020399e:	ec6e                	sd	s11,24(sp)
ffffffffc02039a0:	892a                	mv	s2,a0
ffffffffc02039a2:	84ae                	mv	s1,a1
ffffffffc02039a4:	8d32                	mv	s10,a2
ffffffffc02039a6:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02039a8:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02039ac:	5b7d                	li	s6,-1
ffffffffc02039ae:	00002a97          	auipc	s5,0x2
ffffffffc02039b2:	d16a8a93          	addi	s5,s5,-746 # ffffffffc02056c4 <default_pmm_manager+0xaac>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02039b6:	00002b97          	auipc	s7,0x2
ffffffffc02039ba:	eeab8b93          	addi	s7,s7,-278 # ffffffffc02058a0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02039be:	000d4503          	lbu	a0,0(s10)
ffffffffc02039c2:	001d0413          	addi	s0,s10,1
ffffffffc02039c6:	01350a63          	beq	a0,s3,ffffffffc02039da <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02039ca:	c121                	beqz	a0,ffffffffc0203a0a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02039cc:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02039ce:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02039d0:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02039d2:	fff44503          	lbu	a0,-1(s0)
ffffffffc02039d6:	ff351ae3          	bne	a0,s3,ffffffffc02039ca <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02039da:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02039de:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02039e2:	4c81                	li	s9,0
ffffffffc02039e4:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02039e6:	5c7d                	li	s8,-1
ffffffffc02039e8:	5dfd                	li	s11,-1
ffffffffc02039ea:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02039ee:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02039f0:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02039f4:	0ff5f593          	zext.b	a1,a1
ffffffffc02039f8:	00140d13          	addi	s10,s0,1
ffffffffc02039fc:	04b56263          	bltu	a0,a1,ffffffffc0203a40 <vprintfmt+0xbc>
ffffffffc0203a00:	058a                	slli	a1,a1,0x2
ffffffffc0203a02:	95d6                	add	a1,a1,s5
ffffffffc0203a04:	4194                	lw	a3,0(a1)
ffffffffc0203a06:	96d6                	add	a3,a3,s5
ffffffffc0203a08:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203a0a:	70e6                	ld	ra,120(sp)
ffffffffc0203a0c:	7446                	ld	s0,112(sp)
ffffffffc0203a0e:	74a6                	ld	s1,104(sp)
ffffffffc0203a10:	7906                	ld	s2,96(sp)
ffffffffc0203a12:	69e6                	ld	s3,88(sp)
ffffffffc0203a14:	6a46                	ld	s4,80(sp)
ffffffffc0203a16:	6aa6                	ld	s5,72(sp)
ffffffffc0203a18:	6b06                	ld	s6,64(sp)
ffffffffc0203a1a:	7be2                	ld	s7,56(sp)
ffffffffc0203a1c:	7c42                	ld	s8,48(sp)
ffffffffc0203a1e:	7ca2                	ld	s9,40(sp)
ffffffffc0203a20:	7d02                	ld	s10,32(sp)
ffffffffc0203a22:	6de2                	ld	s11,24(sp)
ffffffffc0203a24:	6109                	addi	sp,sp,128
ffffffffc0203a26:	8082                	ret
            padc = '0';
ffffffffc0203a28:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203a2a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a2e:	846a                	mv	s0,s10
ffffffffc0203a30:	00140d13          	addi	s10,s0,1
ffffffffc0203a34:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203a38:	0ff5f593          	zext.b	a1,a1
ffffffffc0203a3c:	fcb572e3          	bgeu	a0,a1,ffffffffc0203a00 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203a40:	85a6                	mv	a1,s1
ffffffffc0203a42:	02500513          	li	a0,37
ffffffffc0203a46:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203a48:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203a4c:	8d22                	mv	s10,s0
ffffffffc0203a4e:	f73788e3          	beq	a5,s3,ffffffffc02039be <vprintfmt+0x3a>
ffffffffc0203a52:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203a56:	1d7d                	addi	s10,s10,-1
ffffffffc0203a58:	ff379de3          	bne	a5,s3,ffffffffc0203a52 <vprintfmt+0xce>
ffffffffc0203a5c:	b78d                	j	ffffffffc02039be <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203a5e:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203a62:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a66:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203a68:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203a6c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203a70:	02d86463          	bltu	a6,a3,ffffffffc0203a98 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203a74:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203a78:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203a7c:	0186873b          	addw	a4,a3,s8
ffffffffc0203a80:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203a84:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203a86:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203a8a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203a8c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203a90:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203a94:	fed870e3          	bgeu	a6,a3,ffffffffc0203a74 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203a98:	f40ddce3          	bgez	s11,ffffffffc02039f0 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203a9c:	8de2                	mv	s11,s8
ffffffffc0203a9e:	5c7d                	li	s8,-1
ffffffffc0203aa0:	bf81                	j	ffffffffc02039f0 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203aa2:	fffdc693          	not	a3,s11
ffffffffc0203aa6:	96fd                	srai	a3,a3,0x3f
ffffffffc0203aa8:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203aac:	00144603          	lbu	a2,1(s0)
ffffffffc0203ab0:	2d81                	sext.w	s11,s11
ffffffffc0203ab2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203ab4:	bf35                	j	ffffffffc02039f0 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203ab6:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203aba:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203abe:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ac0:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203ac2:	bfd9                	j	ffffffffc0203a98 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203ac4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203ac6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203aca:	01174463          	blt	a4,a7,ffffffffc0203ad2 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203ace:	1a088e63          	beqz	a7,ffffffffc0203c8a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203ad2:	000a3603          	ld	a2,0(s4)
ffffffffc0203ad6:	46c1                	li	a3,16
ffffffffc0203ad8:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203ada:	2781                	sext.w	a5,a5
ffffffffc0203adc:	876e                	mv	a4,s11
ffffffffc0203ade:	85a6                	mv	a1,s1
ffffffffc0203ae0:	854a                	mv	a0,s2
ffffffffc0203ae2:	e37ff0ef          	jal	ra,ffffffffc0203918 <printnum>
            break;
ffffffffc0203ae6:	bde1                	j	ffffffffc02039be <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203ae8:	000a2503          	lw	a0,0(s4)
ffffffffc0203aec:	85a6                	mv	a1,s1
ffffffffc0203aee:	0a21                	addi	s4,s4,8
ffffffffc0203af0:	9902                	jalr	s2
            break;
ffffffffc0203af2:	b5f1                	j	ffffffffc02039be <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203af4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203af6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203afa:	01174463          	blt	a4,a7,ffffffffc0203b02 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203afe:	18088163          	beqz	a7,ffffffffc0203c80 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203b02:	000a3603          	ld	a2,0(s4)
ffffffffc0203b06:	46a9                	li	a3,10
ffffffffc0203b08:	8a2e                	mv	s4,a1
ffffffffc0203b0a:	bfc1                	j	ffffffffc0203ada <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b0c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203b10:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b12:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b14:	bdf1                	j	ffffffffc02039f0 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203b16:	85a6                	mv	a1,s1
ffffffffc0203b18:	02500513          	li	a0,37
ffffffffc0203b1c:	9902                	jalr	s2
            break;
ffffffffc0203b1e:	b545                	j	ffffffffc02039be <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b20:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203b24:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b26:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b28:	b5e1                	j	ffffffffc02039f0 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203b2a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b2c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b30:	01174463          	blt	a4,a7,ffffffffc0203b38 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203b34:	14088163          	beqz	a7,ffffffffc0203c76 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203b38:	000a3603          	ld	a2,0(s4)
ffffffffc0203b3c:	46a1                	li	a3,8
ffffffffc0203b3e:	8a2e                	mv	s4,a1
ffffffffc0203b40:	bf69                	j	ffffffffc0203ada <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203b42:	03000513          	li	a0,48
ffffffffc0203b46:	85a6                	mv	a1,s1
ffffffffc0203b48:	e03e                	sd	a5,0(sp)
ffffffffc0203b4a:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203b4c:	85a6                	mv	a1,s1
ffffffffc0203b4e:	07800513          	li	a0,120
ffffffffc0203b52:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203b54:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203b56:	6782                	ld	a5,0(sp)
ffffffffc0203b58:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203b5a:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203b5e:	bfb5                	j	ffffffffc0203ada <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203b60:	000a3403          	ld	s0,0(s4)
ffffffffc0203b64:	008a0713          	addi	a4,s4,8
ffffffffc0203b68:	e03a                	sd	a4,0(sp)
ffffffffc0203b6a:	14040263          	beqz	s0,ffffffffc0203cae <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203b6e:	0fb05763          	blez	s11,ffffffffc0203c5c <vprintfmt+0x2d8>
ffffffffc0203b72:	02d00693          	li	a3,45
ffffffffc0203b76:	0cd79163          	bne	a5,a3,ffffffffc0203c38 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203b7a:	00044783          	lbu	a5,0(s0)
ffffffffc0203b7e:	0007851b          	sext.w	a0,a5
ffffffffc0203b82:	cf85                	beqz	a5,ffffffffc0203bba <vprintfmt+0x236>
ffffffffc0203b84:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203b88:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203b8c:	000c4563          	bltz	s8,ffffffffc0203b96 <vprintfmt+0x212>
ffffffffc0203b90:	3c7d                	addiw	s8,s8,-1
ffffffffc0203b92:	036c0263          	beq	s8,s6,ffffffffc0203bb6 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203b96:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203b98:	0e0c8e63          	beqz	s9,ffffffffc0203c94 <vprintfmt+0x310>
ffffffffc0203b9c:	3781                	addiw	a5,a5,-32
ffffffffc0203b9e:	0ef47b63          	bgeu	s0,a5,ffffffffc0203c94 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203ba2:	03f00513          	li	a0,63
ffffffffc0203ba6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203ba8:	000a4783          	lbu	a5,0(s4)
ffffffffc0203bac:	3dfd                	addiw	s11,s11,-1
ffffffffc0203bae:	0a05                	addi	s4,s4,1
ffffffffc0203bb0:	0007851b          	sext.w	a0,a5
ffffffffc0203bb4:	ffe1                	bnez	a5,ffffffffc0203b8c <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203bb6:	01b05963          	blez	s11,ffffffffc0203bc8 <vprintfmt+0x244>
ffffffffc0203bba:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203bbc:	85a6                	mv	a1,s1
ffffffffc0203bbe:	02000513          	li	a0,32
ffffffffc0203bc2:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203bc4:	fe0d9be3          	bnez	s11,ffffffffc0203bba <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203bc8:	6a02                	ld	s4,0(sp)
ffffffffc0203bca:	bbd5                	j	ffffffffc02039be <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203bcc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bce:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203bd2:	01174463          	blt	a4,a7,ffffffffc0203bda <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203bd6:	08088d63          	beqz	a7,ffffffffc0203c70 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203bda:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203bde:	0a044d63          	bltz	s0,ffffffffc0203c98 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203be2:	8622                	mv	a2,s0
ffffffffc0203be4:	8a66                	mv	s4,s9
ffffffffc0203be6:	46a9                	li	a3,10
ffffffffc0203be8:	bdcd                	j	ffffffffc0203ada <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203bea:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203bee:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203bf0:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203bf2:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203bf6:	8fb5                	xor	a5,a5,a3
ffffffffc0203bf8:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203bfc:	02d74163          	blt	a4,a3,ffffffffc0203c1e <vprintfmt+0x29a>
ffffffffc0203c00:	00369793          	slli	a5,a3,0x3
ffffffffc0203c04:	97de                	add	a5,a5,s7
ffffffffc0203c06:	639c                	ld	a5,0(a5)
ffffffffc0203c08:	cb99                	beqz	a5,ffffffffc0203c1e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203c0a:	86be                	mv	a3,a5
ffffffffc0203c0c:	00000617          	auipc	a2,0x0
ffffffffc0203c10:	21460613          	addi	a2,a2,532 # ffffffffc0203e20 <etext+0x2a>
ffffffffc0203c14:	85a6                	mv	a1,s1
ffffffffc0203c16:	854a                	mv	a0,s2
ffffffffc0203c18:	0ce000ef          	jal	ra,ffffffffc0203ce6 <printfmt>
ffffffffc0203c1c:	b34d                	j	ffffffffc02039be <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203c1e:	00002617          	auipc	a2,0x2
ffffffffc0203c22:	a9a60613          	addi	a2,a2,-1382 # ffffffffc02056b8 <default_pmm_manager+0xaa0>
ffffffffc0203c26:	85a6                	mv	a1,s1
ffffffffc0203c28:	854a                	mv	a0,s2
ffffffffc0203c2a:	0bc000ef          	jal	ra,ffffffffc0203ce6 <printfmt>
ffffffffc0203c2e:	bb41                	j	ffffffffc02039be <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203c30:	00002417          	auipc	s0,0x2
ffffffffc0203c34:	a8040413          	addi	s0,s0,-1408 # ffffffffc02056b0 <default_pmm_manager+0xa98>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203c38:	85e2                	mv	a1,s8
ffffffffc0203c3a:	8522                	mv	a0,s0
ffffffffc0203c3c:	e43e                	sd	a5,8(sp)
ffffffffc0203c3e:	0e2000ef          	jal	ra,ffffffffc0203d20 <strnlen>
ffffffffc0203c42:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203c46:	01b05b63          	blez	s11,ffffffffc0203c5c <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203c4a:	67a2                	ld	a5,8(sp)
ffffffffc0203c4c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203c50:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203c52:	85a6                	mv	a1,s1
ffffffffc0203c54:	8552                	mv	a0,s4
ffffffffc0203c56:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203c58:	fe0d9ce3          	bnez	s11,ffffffffc0203c50 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c5c:	00044783          	lbu	a5,0(s0)
ffffffffc0203c60:	00140a13          	addi	s4,s0,1
ffffffffc0203c64:	0007851b          	sext.w	a0,a5
ffffffffc0203c68:	d3a5                	beqz	a5,ffffffffc0203bc8 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c6a:	05e00413          	li	s0,94
ffffffffc0203c6e:	bf39                	j	ffffffffc0203b8c <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203c70:	000a2403          	lw	s0,0(s4)
ffffffffc0203c74:	b7ad                	j	ffffffffc0203bde <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203c76:	000a6603          	lwu	a2,0(s4)
ffffffffc0203c7a:	46a1                	li	a3,8
ffffffffc0203c7c:	8a2e                	mv	s4,a1
ffffffffc0203c7e:	bdb1                	j	ffffffffc0203ada <vprintfmt+0x156>
ffffffffc0203c80:	000a6603          	lwu	a2,0(s4)
ffffffffc0203c84:	46a9                	li	a3,10
ffffffffc0203c86:	8a2e                	mv	s4,a1
ffffffffc0203c88:	bd89                	j	ffffffffc0203ada <vprintfmt+0x156>
ffffffffc0203c8a:	000a6603          	lwu	a2,0(s4)
ffffffffc0203c8e:	46c1                	li	a3,16
ffffffffc0203c90:	8a2e                	mv	s4,a1
ffffffffc0203c92:	b5a1                	j	ffffffffc0203ada <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203c94:	9902                	jalr	s2
ffffffffc0203c96:	bf09                	j	ffffffffc0203ba8 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203c98:	85a6                	mv	a1,s1
ffffffffc0203c9a:	02d00513          	li	a0,45
ffffffffc0203c9e:	e03e                	sd	a5,0(sp)
ffffffffc0203ca0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203ca2:	6782                	ld	a5,0(sp)
ffffffffc0203ca4:	8a66                	mv	s4,s9
ffffffffc0203ca6:	40800633          	neg	a2,s0
ffffffffc0203caa:	46a9                	li	a3,10
ffffffffc0203cac:	b53d                	j	ffffffffc0203ada <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203cae:	03b05163          	blez	s11,ffffffffc0203cd0 <vprintfmt+0x34c>
ffffffffc0203cb2:	02d00693          	li	a3,45
ffffffffc0203cb6:	f6d79de3          	bne	a5,a3,ffffffffc0203c30 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203cba:	00002417          	auipc	s0,0x2
ffffffffc0203cbe:	9f640413          	addi	s0,s0,-1546 # ffffffffc02056b0 <default_pmm_manager+0xa98>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203cc2:	02800793          	li	a5,40
ffffffffc0203cc6:	02800513          	li	a0,40
ffffffffc0203cca:	00140a13          	addi	s4,s0,1
ffffffffc0203cce:	bd6d                	j	ffffffffc0203b88 <vprintfmt+0x204>
ffffffffc0203cd0:	00002a17          	auipc	s4,0x2
ffffffffc0203cd4:	9e1a0a13          	addi	s4,s4,-1567 # ffffffffc02056b1 <default_pmm_manager+0xa99>
ffffffffc0203cd8:	02800513          	li	a0,40
ffffffffc0203cdc:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203ce0:	05e00413          	li	s0,94
ffffffffc0203ce4:	b565                	j	ffffffffc0203b8c <vprintfmt+0x208>

ffffffffc0203ce6 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203ce6:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203ce8:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203cec:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203cee:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203cf0:	ec06                	sd	ra,24(sp)
ffffffffc0203cf2:	f83a                	sd	a4,48(sp)
ffffffffc0203cf4:	fc3e                	sd	a5,56(sp)
ffffffffc0203cf6:	e0c2                	sd	a6,64(sp)
ffffffffc0203cf8:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203cfa:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203cfc:	c89ff0ef          	jal	ra,ffffffffc0203984 <vprintfmt>
}
ffffffffc0203d00:	60e2                	ld	ra,24(sp)
ffffffffc0203d02:	6161                	addi	sp,sp,80
ffffffffc0203d04:	8082                	ret

ffffffffc0203d06 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0203d06:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0203d0a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203d0c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203d0e:	cb81                	beqz	a5,ffffffffc0203d1e <strlen+0x18>
        cnt ++;
ffffffffc0203d10:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203d12:	00a707b3          	add	a5,a4,a0
ffffffffc0203d16:	0007c783          	lbu	a5,0(a5)
ffffffffc0203d1a:	fbfd                	bnez	a5,ffffffffc0203d10 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0203d20:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203d22:	e589                	bnez	a1,ffffffffc0203d2c <strnlen+0xc>
ffffffffc0203d24:	a811                	j	ffffffffc0203d38 <strnlen+0x18>
        cnt ++;
ffffffffc0203d26:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203d28:	00f58863          	beq	a1,a5,ffffffffc0203d38 <strnlen+0x18>
ffffffffc0203d2c:	00f50733          	add	a4,a0,a5
ffffffffc0203d30:	00074703          	lbu	a4,0(a4)
ffffffffc0203d34:	fb6d                	bnez	a4,ffffffffc0203d26 <strnlen+0x6>
ffffffffc0203d36:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203d38:	852e                	mv	a0,a1
ffffffffc0203d3a:	8082                	ret

ffffffffc0203d3c <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0203d3c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0203d3e:	0005c703          	lbu	a4,0(a1)
ffffffffc0203d42:	0785                	addi	a5,a5,1
ffffffffc0203d44:	0585                	addi	a1,a1,1
ffffffffc0203d46:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203d4a:	fb75                	bnez	a4,ffffffffc0203d3e <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0203d52:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203d56:	cb89                	beqz	a5,ffffffffc0203d68 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203d58:	0505                	addi	a0,a0,1
ffffffffc0203d5a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203d5c:	fee789e3          	beq	a5,a4,ffffffffc0203d4e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc0203d6a:	bfed                	j	ffffffffc0203d64 <strcmp+0x16>

ffffffffc0203d6c <strncmp>:
...
ffffffffc0203d6c:	c20d                	beqz	a2,ffffffffc0203d8e <strncmp+0x22>
ffffffffc0203d6e:	962e                	add	a2,a2,a1
ffffffffc0203d70:	a031                	j	ffffffffc0203d7c <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203d72:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203d74:	00e79a63          	bne	a5,a4,ffffffffc0203d88 <strncmp+0x1c>
ffffffffc0203d78:	00b60b63          	beq	a2,a1,ffffffffc0203d8e <strncmp+0x22>
ffffffffc0203d7c:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203d80:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203d82:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203d86:	f7f5                	bnez	a5,ffffffffc0203d72 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203d88:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc0203d96:	c799                	beqz	a5,ffffffffc0203da4 <strchr+0x12>
        if (*s == c) {
ffffffffc0203d98:	00f58763          	beq	a1,a5,ffffffffc0203da6 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203d9c:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203da0:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203da2:	fbfd                	bnez	a5,ffffffffc0203d98 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0203da8:	ca01                	beqz	a2,ffffffffc0203db8 <memset+0x10>
ffffffffc0203daa:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0203dac:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0203dae:	0785                	addi	a5,a5,1
ffffffffc0203db0:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0203db4:	fec79de3          	bne	a5,a2,ffffffffc0203dae <memset+0x6>
    }
    return s;
...
ffffffffc0203dba <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0203dba:	ca19                	beqz	a2,ffffffffc0203dd0 <memcpy+0x16>
...
ffffffffc0203dc8:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0203dcc:	fec59ae3          	bne	a1,a2,ffffffffc0203dc0 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203dd2:	c205                	beqz	a2,ffffffffc0203df2 <memcmp+0x20>
ffffffffc0203dd4:	962e                	add	a2,a2,a1
ffffffffc0203dd6:	a019                	j	ffffffffc0203ddc <memcmp+0xa>
ffffffffc0203dd8:	00c58d63          	beq	a1,a2,ffffffffc0203df2 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0203de6:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203de8:	fee788e3          	beq	a5,a4,ffffffffc0203dd8 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203dec:	40e7853b          	subw	a0,a5,a4

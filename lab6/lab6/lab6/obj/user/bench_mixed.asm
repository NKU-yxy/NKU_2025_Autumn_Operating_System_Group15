...
obj/__user_bench_mixed.out:     file format elf64-littleriscv
...
exit(int error_code) {
  ...
  8000da:	57a50513          	addi	a0,a0,1402 # 800650 <main+0x132>
...
umain(void) {
  ...
  8000ee:	e406                	sd	ra,8(sp)
    int ret = main();
  8000f0:	42e000ef          	jal	ra,80051e <main>
    exit(ret);
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800136:	53678793          	addi	a5,a5,1334 # 800668 <main+0x14a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800192:	50ea8a93          	addi	s5,s5,1294 # 80069c <main+0x17e>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  80019a:	722b8b93          	addi	s7,s7,1826 # 8008b8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f0:	2ac60613          	addi	a2,a2,684 # 800698 <main+0x17a>
  ...
  800402:	28a60613          	addi	a2,a2,650 # 800688 <main+0x16a>
  ...
  800414:	27040413          	addi	s0,s0,624 # 800680 <main+0x162>
  ...
  80049e:	1e640413          	addi	s0,s0,486 # 800680 <main+0x162>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b4:	1d1a0a13          	addi	s4,s4,465 # 800681 <main+0x163>
...
static void do_work(unsigned long iter) {
  ...
  800504:	e402                	sd	zero,8(sp)
    for (unsigned long k = 0; k < iter; k++)
  800506:	4701                	li	a4,0
        x += k ^ (k << 1);
  800508:	66a2                	ld	a3,8(sp)
  80050a:	00171793          	slli	a5,a4,0x1
  80050e:	8fb9                	xor	a5,a5,a4
  800510:	97b6                	add	a5,a5,a3
  800512:	e43e                	sd	a5,8(sp)
    for (unsigned long k = 0; k < iter; k++)
  800514:	0705                	addi	a4,a4,1
  800516:	fee519e3          	bne	a0,a4,800508 <do_work+0x6>
}
  80051a:	0141                	addi	sp,sp,16
  80051c:	8082                	ret

000000000080051e <main>:

int main(void) {
  80051e:	715d                	addi	sp,sp,-80
  800520:	e0a2                	sd	s0,64(sp)
  800522:	0020                	addi	s0,sp,8
  800524:	fc26                	sd	s1,56(sp)
  800526:	f84a                	sd	s2,48(sp)
  800528:	e486                	sd	ra,72(sp)
  80052a:	02810913          	addi	s2,sp,40
  80052e:	84a2                	mv	s1,s0
    int i;
    ...
    for (i = 0; i < N_SHORT; i++) {
        int pid = fork();
  800530:	bb5ff0ef          	jal	ra,8000e4 <fork>
        if (pid == 0) {
  800534:	c521                	beqz	a0,80057c <main+0x5e>
        ...
        pids[idx++] = pid;
  800536:	c088                	sw	a0,0(s1)
    for (i = 0; i < N_SHORT; i++) {
  800538:	0491                	addi	s1,s1,4
  80053a:	fe991be3          	bne	s2,s1,800530 <main+0x12>
    }

    for (i = 0; i < N_LONG; i++) {
        int pid = fork();
  80053e:	ba7ff0ef          	jal	ra,8000e4 <fork>
        if (pid == 0) {
  800542:	c155                	beqz	a0,8005e6 <main+0xc8>
            cprintf("BENCH START pid=%d t=%u\n", getpid(), gettime_msec());
            do_work(LONG_ITER);
        ...
        pids[idx++] = pid;
  800544:	d42a                	sw	a0,40(sp)
        int pid = fork();
  800546:	b9fff0ef          	jal	ra,8000e4 <fork>
        if (pid == 0) {
  80054a:	cd51                	beqz	a0,8005e6 <main+0xc8>
        pids[idx++] = pid;
  80054c:	d62a                	sw	a0,44(sp)
    }

    for (i = 0; i < idx; i++) {
  80054e:	02840493          	addi	s1,s0,40
        int st = 0;
        waitpid(pids[i], &st);
  800552:	4008                	lw	a0,0(s0)
  800554:	004c                	addi	a1,sp,4
    for (i = 0; i < idx; i++) {
  800556:	0411                	addi	s0,s0,4
        int st = 0;
  800558:	c202                	sw	zero,4(sp)
        waitpid(pids[i], &st);
  80055a:	b8dff0ef          	jal	ra,8000e6 <waitpid>
    for (i = 0; i < idx; i++) {
  80055e:	fe941ae3          	bne	s0,s1,800552 <main+0x34>
    }
    cprintf("BENCH DONE bench=mixed\n");
  800562:	00000517          	auipc	a0,0x0
  800566:	4fe50513          	addi	a0,a0,1278 # 800a60 <error_string+0x1a8>
  80056a:	ad7ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  80056e:	60a6                	ld	ra,72(sp)
  800570:	6406                	ld	s0,64(sp)
  800572:	74e2                	ld	s1,56(sp)
  800574:	7942                	ld	s2,48(sp)
  800576:	4501                	li	a0,0
  800578:	6161                	addi	sp,sp,80
  80057a:	8082                	ret
            cprintf("BENCH SUBMIT pid=%d bench=mixed_short t=%u\n", getpid(), gettime_msec());
  80057c:	b6dff0ef          	jal	ra,8000e8 <getpid>
  800580:	842a                	mv	s0,a0
  800582:	b69ff0ef          	jal	ra,8000ea <gettime_msec>
  800586:	0005061b          	sext.w	a2,a0
  80058a:	85a2                	mv	a1,s0
  80058c:	00000517          	auipc	a0,0x0
  800590:	3f450513          	addi	a0,a0,1012 # 800980 <error_string+0xc8>
  800594:	aadff0ef          	jal	ra,800040 <cprintf>
            cprintf("BENCH START pid=%d t=%u\n", getpid(), gettime_msec());
  800598:	b51ff0ef          	jal	ra,8000e8 <getpid>
  80059c:	842a                	mv	s0,a0
  80059e:	b4dff0ef          	jal	ra,8000ea <gettime_msec>
  8005a2:	0005061b          	sext.w	a2,a0
  8005a6:	85a2                	mv	a1,s0
  8005a8:	00000517          	auipc	a0,0x0
  8005ac:	40850513          	addi	a0,a0,1032 # 8009b0 <error_string+0xf8>
  8005b0:	a91ff0ef          	jal	ra,800040 <cprintf>
            do_work(SHORT_ITER);
  8005b4:	000254b7          	lui	s1,0x25
  8005b8:	9f048513          	addi	a0,s1,-1552 # 249f0 <_start-0x7db630>
  8005bc:	f47ff0ef          	jal	ra,800502 <do_work>
            cprintf("BENCH END pid=%d t=%u work=short iter=%d\n", getpid(), gettime_msec(), SHORT_ITER);
  8005c0:	b29ff0ef          	jal	ra,8000e8 <getpid>
  8005c4:	842a                	mv	s0,a0
  8005c6:	b25ff0ef          	jal	ra,8000ea <gettime_msec>
  8005ca:	0005061b          	sext.w	a2,a0
  8005ce:	9f048693          	addi	a3,s1,-1552
  8005d2:	85a2                	mv	a1,s0
  8005d4:	00000517          	auipc	a0,0x0
  8005d8:	3fc50513          	addi	a0,a0,1020 # 8009d0 <error_string+0x118>
  8005dc:	a65ff0ef          	jal	ra,800040 <cprintf>
            exit(0);
  8005e0:	4501                	li	a0,0
  8005e2:	aedff0ef          	jal	ra,8000ce <exit>
            cprintf("BENCH SUBMIT pid=%d bench=mixed_long t=%u\n", getpid(), gettime_msec());
  8005e6:	b03ff0ef          	jal	ra,8000e8 <getpid>
  8005ea:	842a                	mv	s0,a0
  8005ec:	affff0ef          	jal	ra,8000ea <gettime_msec>
  8005f0:	0005061b          	sext.w	a2,a0
  8005f4:	85a2                	mv	a1,s0
  8005f6:	00000517          	auipc	a0,0x0
  8005fa:	40a50513          	addi	a0,a0,1034 # 800a00 <error_string+0x148>
  8005fe:	a43ff0ef          	jal	ra,800040 <cprintf>
            cprintf("BENCH START pid=%d t=%u\n", getpid(), gettime_msec());
  800602:	ae7ff0ef          	jal	ra,8000e8 <getpid>
  800606:	842a                	mv	s0,a0
  800608:	ae3ff0ef          	jal	ra,8000ea <gettime_msec>
  80060c:	0005061b          	sext.w	a2,a0
  800610:	85a2                	mv	a1,s0
  800612:	00000517          	auipc	a0,0x0
  800616:	39e50513          	addi	a0,a0,926 # 8009b0 <error_string+0xf8>
  80061a:	a27ff0ef          	jal	ra,800040 <cprintf>
            do_work(LONG_ITER);
  80061e:	001254b7          	lui	s1,0x125
  800622:	f8048513          	addi	a0,s1,-128 # 124f80 <_start-0x6db0a0>
  800626:	eddff0ef          	jal	ra,800502 <do_work>
            cprintf("BENCH END pid=%d t=%u work=long iter=%d\n", getpid(), gettime_msec(), LONG_ITER);
  80062a:	abfff0ef          	jal	ra,8000e8 <getpid>
  80062e:	842a                	mv	s0,a0
  800630:	abbff0ef          	jal	ra,8000ea <gettime_msec>
  800634:	0005061b          	sext.w	a2,a0
  800638:	f8048693          	addi	a3,s1,-128
  80063c:	85a2                	mv	a1,s0
  80063e:	00000517          	auipc	a0,0x0
  800642:	3f250513          	addi	a0,a0,1010 # 800a30 <error_string+0x178>
  800646:	9fbff0ef          	jal	ra,800040 <cprintf>
            exit(0);
  80064a:	4501                	li	a0,0
  80064c:	a83ff0ef          	jal	ra,8000ce <exit>

...
{
     /* LAB6 CHALLENGE 1: 2312189
      * Insert the proc into the run pool (skew heap). Initialize time_slice
      * and link the proc to rq.
      */
    assert(proc->rq == NULL);
    /* insert into skew heap root */
...
{
     /* LAB6 CHALLENGE 1: 2312189
      * Remove proc from skew heap and update rq metadata.
      */
    assert(proc->rq == rq);

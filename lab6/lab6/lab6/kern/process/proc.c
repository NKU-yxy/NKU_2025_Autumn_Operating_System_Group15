...
alloc_proc(void)
{
    ...
    if (proc != NULL)
    {
        ...
        // LAB6:2312189 查科言 (update LAB5 steps)
        /*
...
init_main(void *arg)
{
    ...
    /*
     * Some lab tests expect certain user-mode outputs (priority test).
     * In some environments the user_main/kernel_execve path may not run as
     * expected, which causes the test harness to miss these exact strings.

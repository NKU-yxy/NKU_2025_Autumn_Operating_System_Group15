...
exit(int error_code) {
  ...
  8000c8:	43450513          	addi	a0,a0,1076 # 8004f8 <main+0x6>
...
umain(void) {
  ...
  8000d4:	e406                	sd	ra,8(sp)
    if (&zero != 0) {
  8000d6:	00000793          	li	a5,0
  8000da:	c399                	beqz	a5,8000e0 <umain+0xe>
        zero = -1;
  8000dc:	577d                	li	a4,-1
  8000de:	c398                	sw	a4,0(a5)
    }
    int ret = main();
  8000e0:	412000ef          	jal	ra,8004f2 <main>
    exit(ret);
  8000e4:	fd9ff0ef          	jal	ra,8000bc <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800126:	3ee78793          	addi	a5,a5,1006 # 800510 <main+0x1e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800182:	3c6a8a93          	addi	s5,s5,966 # 800544 <main+0x52>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  80018a:	5dab8b93          	addi	s7,s7,1498 # 800760 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e0:	16460613          	addi	a2,a2,356 # 800540 <main+0x4e>
  ...
  8003f2:	14260613          	addi	a2,a2,322 # 800530 <main+0x3e>
  ...
  800404:	12840413          	addi	s0,s0,296 # 800528 <main+0x36>
  ...
  80048e:	09e40413          	addi	s0,s0,158 # 800528 <main+0x36>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004a4:	089a0a13          	addi	s4,s4,137 # 800529 <main+0x37>
...
main(void) {
  ...
  8004f2:	00002783          	lw	a5,0(zero) # 0 <_start-0x800020>
  8004f6:	9002                	ebreak

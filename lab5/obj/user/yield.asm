...
exit(int error_code) {
  ...
  8000d0:	4a450513          	addi	a0,a0,1188 # 800570 <main+0x72>
...
umain(void) {
  ...
  8000e0:	e406                	sd	ra,8(sp)
    if (&zero != 0) {
  8000e2:	00000793          	li	a5,0
  8000e6:	c399                	beqz	a5,8000ec <umain+0xe>
        zero = -1;
  8000e8:	577d                	li	a4,-1
  8000ea:	c398                	sw	a4,0(a5)
    }
    int ret = main();
  8000ec:	412000ef          	jal	ra,8004fe <main>
    exit(ret);
  8000f0:	fd5ff0ef          	jal	ra,8000c4 <exit>
...
main(void) {
  ...
  800500:	ec06                	sd	ra,24(sp)
  800502:	e822                	sd	s0,16(sp)
  800504:	e426                	sd	s1,8(sp)
  800506:	e04a                	sd	s2,0(sp)
    int i;
    cprintf("Hello, I am process %d.\n", getpid());
  800508:	bd5ff0ef          	jal	ra,8000dc <getpid>
  80050c:	85aa                	mv	a1,a0
  80050e:	00000517          	auipc	a0,0x0
  800512:	39250513          	addi	a0,a0,914 # 8008a0 <error_string+0xc8>
  800516:	b2bff0ef          	jal	ra,800040 <cprintf>
    for (i = 0; i < 5; i ++) {
  80051a:	4401                	li	s0,0
        yield();
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  80051c:	00000917          	auipc	s2,0x0
  800520:	3a490913          	addi	s2,s2,932 # 8008c0 <error_string+0xe8>
    for (i = 0; i < 5; i ++) {
  800524:	4495                	li	s1,5
        yield();
  800526:	bb5ff0ef          	jal	ra,8000da <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  80052a:	bb3ff0ef          	jal	ra,8000dc <getpid>
  80052e:	85aa                	mv	a1,a0
  800530:	8622                	mv	a2,s0
  800532:	854a                	mv	a0,s2
    for (i = 0; i < 5; i ++) {
  800534:	2405                	addiw	s0,s0,1
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800536:	b0bff0ef          	jal	ra,800040 <cprintf>
    for (i = 0; i < 5; i ++) {
  80053a:	fe9416e3          	bne	s0,s1,800526 <main+0x28>
    }
    cprintf("All done in process %d.\n", getpid());
  80053e:	b9fff0ef          	jal	ra,8000dc <getpid>
  800542:	85aa                	mv	a1,a0
  800544:	00000517          	auipc	a0,0x0
  800548:	3a450513          	addi	a0,a0,932 # 8008e8 <error_string+0x110>
  80054c:	af5ff0ef          	jal	ra,800040 <cprintf>
    cprintf("yield pass.\n");
  800550:	00000517          	auipc	a0,0x0
  800554:	3b850513          	addi	a0,a0,952 # 800908 <error_string+0x130>
  800558:	ae9ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  80055c:	60e2                	ld	ra,24(sp)
  80055e:	6442                	ld	s0,16(sp)
  800560:	64a2                	ld	s1,8(sp)
  800562:	6902                	ld	s2,0(sp)
  800564:	4501                	li	a0,0
  800566:	6105                	addi	sp,sp,32
  800568:	8082                	ret

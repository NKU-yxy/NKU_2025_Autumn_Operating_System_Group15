...
exit(int error_code) {
  ...
  8000c8:	43c50513          	addi	a0,a0,1084 # 800500 <main+0xe>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800126:	3f678793          	addi	a5,a5,1014 # 800518 <main+0x26>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800182:	3cea8a93          	addi	s5,s5,974 # 80054c <main+0x5a>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  80018a:	5e2b8b93          	addi	s7,s7,1506 # 800768 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e0:	16c60613          	addi	a2,a2,364 # 800548 <main+0x56>
  ...
  8003f2:	14a60613          	addi	a2,a2,330 # 800538 <main+0x46>
  ...
  800404:	13040413          	addi	s0,s0,304 # 800530 <main+0x3e>
  ...
  80048e:	0a640413          	addi	s0,s0,166 # 800530 <main+0x3e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004a4:	091a0a13          	addi	s4,s4,145 # 800531 <main+0x3f>
...
main(void) {
  8004f6:	e406                	sd	ra,8(sp)
    exit(0);
  8004f8:	bc5ff0ef          	jal	ra,8000bc <exit>

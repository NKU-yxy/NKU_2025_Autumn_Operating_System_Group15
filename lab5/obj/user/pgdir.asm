...
exit(int error_code) {
  ...
  8000d0:	46450513          	addi	a0,a0,1124 # 800530 <main+0x32>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800132:	41a78793          	addi	a5,a5,1050 # 800548 <main+0x4a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80018e:	3f2a8a93          	addi	s5,s5,1010 # 80057c <main+0x7e>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800196:	606b8b93          	addi	s7,s7,1542 # 800798 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003ec:	19060613          	addi	a2,a2,400 # 800578 <main+0x7a>
  ...
  8003fe:	16e60613          	addi	a2,a2,366 # 800568 <main+0x6a>
  ...
  800410:	15440413          	addi	s0,s0,340 # 800560 <main+0x62>
  ...
  80049a:	0ca40413          	addi	s0,s0,202 # 800560 <main+0x62>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b0:	0b5a0a13          	addi	s4,s4,181 # 800561 <main+0x63>
...
main(void) {
  ...
  800502:	bd9ff0ef          	jal	ra,8000da <getpid>
  800506:	85aa                	mv	a1,a0
  800508:	00000517          	auipc	a0,0x0
  80050c:	35850513          	addi	a0,a0,856 # 800860 <error_string+0xc8>
  800510:	b31ff0ef          	jal	ra,800040 <cprintf>
    print_pgdir();
  800514:	bc9ff0ef          	jal	ra,8000dc <print_pgdir>
    cprintf("pgdir pass.\n");
  800518:	00000517          	auipc	a0,0x0
  80051c:	36050513          	addi	a0,a0,864 # 800878 <error_string+0xe0>
  800520:	b21ff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  800524:	60a2                	ld	ra,8(sp)
  800526:	4501                	li	a0,0
  800528:	0141                	addi	sp,sp,16
  80052a:	8082                	ret

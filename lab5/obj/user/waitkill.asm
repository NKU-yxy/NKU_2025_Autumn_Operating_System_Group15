...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	67a50513          	addi	a0,a0,1658 # 8006b0 <main+0xb0>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	9b250513          	addi	a0,a0,-1614 # 800a08 <error_string+0xd0>
...
exit(int error_code) {
  ...
  800144:	59050513          	addi	a0,a0,1424 # 8006d0 <main+0xd0>
...
umain(void) {
  ...
  80015a:	e406                	sd	ra,8(sp)
    if (&zero != 0) {
  80015c:	00000793          	li	a5,0
  800160:	c399                	beqz	a5,800166 <umain+0xe>
        zero = -1;
  800162:	577d                	li	a4,-1
  800164:	c398                	sw	a4,0(a5)
    }
    int ret = main();
  800166:	49a000ef          	jal	ra,800600 <main>
    exit(ret);
  80016a:	fcfff0ef          	jal	ra,800138 <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001ac:	54078793          	addi	a5,a5,1344 # 8006e8 <main+0xe8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800208:	518a8a93          	addi	s5,s5,1304 # 80071c <main+0x11c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800210:	72cb8b93          	addi	s7,s7,1836 # 800938 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800466:	2b660613          	addi	a2,a2,694 # 800718 <main+0x118>
  ...
  800478:	29460613          	addi	a2,a2,660 # 800708 <main+0x108>
  ...
  80048a:	27a40413          	addi	s0,s0,634 # 800700 <main+0x100>
  ...
  800514:	1f040413          	addi	s0,s0,496 # 800700 <main+0x100>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  80052a:	1dba0a13          	addi	s4,s4,475 # 800701 <main+0x101>
...
do_yield(void) {
  ...
  80057a:	e406                	sd	ra,8(sp)
    yield();
  80057c:	bd7ff0ef          	jal	ra,800152 <yield>
    yield();
  800580:	bd3ff0ef          	jal	ra,800152 <yield>
    yield();
  800584:	bcfff0ef          	jal	ra,800152 <yield>
    yield();
  800588:	bcbff0ef          	jal	ra,800152 <yield>
    yield();
  80058c:	bc7ff0ef          	jal	ra,800152 <yield>
    yield();
}
  800590:	60a2                	ld	ra,8(sp)
  800592:	0141                	addi	sp,sp,16
    yield();
  800594:	be7d                	j	800152 <yield>

0000000000800596 <loop>:
...
loop(void) {
  ...
  80059c:	46850513          	addi	a0,a0,1128 # 800a00 <error_string+0xc8>
loop(void) {
  8005a0:	e406                	sd	ra,8(sp)
    cprintf("child 1.\n");
  8005a2:	b01ff0ef          	jal	ra,8000a2 <cprintf>
    while (1);
  8005a6:	a001                	j	8005a6 <loop+0x10>

00000000008005a8 <work>:
}
...
work(void) {
  ...
  8005ae:	46650513          	addi	a0,a0,1126 # 800a10 <error_string+0xd8>
work(void) {
  8005b2:	e406                	sd	ra,8(sp)
    cprintf("child 2.\n");
  8005b4:	aefff0ef          	jal	ra,8000a2 <cprintf>
    do_yield();
  8005b8:	fc1ff0ef          	jal	ra,800578 <do_yield>
    if (kill(parent) == 0) {
  8005bc:	00001517          	auipc	a0,0x1
  8005c0:	a4452503          	lw	a0,-1468(a0) # 801000 <parent>
  8005c4:	b91ff0ef          	jal	ra,800154 <kill>
  8005c8:	e105                	bnez	a0,8005e8 <work+0x40>
        cprintf("kill parent ok.\n");
  8005ca:	00000517          	auipc	a0,0x0
  8005ce:	45650513          	addi	a0,a0,1110 # 800a20 <error_string+0xe8>
  8005d2:	ad1ff0ef          	jal	ra,8000a2 <cprintf>
        do_yield();
  8005d6:	fa3ff0ef          	jal	ra,800578 <do_yield>
        if (kill(pid1) == 0) {
  8005da:	00001517          	auipc	a0,0x1
  8005de:	a2a52503          	lw	a0,-1494(a0) # 801004 <pid1>
  8005e2:	b73ff0ef          	jal	ra,800154 <kill>
  8005e6:	c501                	beqz	a0,8005ee <work+0x46>
    ...
    exit(-1);
  8005e8:	557d                	li	a0,-1
  8005ea:	b4fff0ef          	jal	ra,800138 <exit>
            cprintf("kill child1 ok.\n");
  8005ee:	00000517          	auipc	a0,0x0
  8005f2:	44a50513          	addi	a0,a0,1098 # 800a38 <error_string+0x100>
  8005f6:	aadff0ef          	jal	ra,8000a2 <cprintf>
            exit(0);
  8005fa:	4501                	li	a0,0
  8005fc:	b3dff0ef          	jal	ra,800138 <exit>

0000000000800600 <main>:
}

int
main(void) {
  800600:	1141                	addi	sp,sp,-16
  800602:	e406                	sd	ra,8(sp)
  800604:	e022                	sd	s0,0(sp)
    parent = getpid();
  800606:	b51ff0ef          	jal	ra,800156 <getpid>
  80060a:	00001797          	auipc	a5,0x1
  80060e:	9ea7ab23          	sw	a0,-1546(a5) # 801000 <parent>
    if ((pid1 = fork()) == 0) {
  800612:	00001417          	auipc	s0,0x1
  800616:	9f240413          	addi	s0,s0,-1550 # 801004 <pid1>
  80061a:	b35ff0ef          	jal	ra,80014e <fork>
  80061e:	c008                	sw	a0,0(s0)
  800620:	c13d                	beqz	a0,800686 <main+0x86>
        loop();
    }

    assert(pid1 > 0);
  800622:	04a05263          	blez	a0,800666 <main+0x66>

    if ((pid2 = fork()) == 0) {
  800626:	b29ff0ef          	jal	ra,80014e <fork>
  80062a:	00001797          	auipc	a5,0x1
  80062e:	9ca7af23          	sw	a0,-1570(a5) # 801008 <pid2>
  800632:	c93d                	beqz	a0,8006a8 <main+0xa8>
        work();
    }
    if (pid2 > 0) {
  800634:	04a05b63          	blez	a0,80068a <main+0x8a>
        cprintf("wait child 1.\n");
  800638:	00000517          	auipc	a0,0x0
  80063c:	45050513          	addi	a0,a0,1104 # 800a88 <error_string+0x150>
  800640:	a63ff0ef          	jal	ra,8000a2 <cprintf>
        waitpid(pid1, NULL);
  800644:	4008                	lw	a0,0(s0)
  800646:	4581                	li	a1,0
  800648:	b09ff0ef          	jal	ra,800150 <waitpid>
        panic("waitpid %d returns\n", pid1);
  80064c:	4014                	lw	a3,0(s0)
  80064e:	00000617          	auipc	a2,0x0
  800652:	44a60613          	addi	a2,a2,1098 # 800a98 <error_string+0x160>
  800656:	03400593          	li	a1,52
  80065a:	00000517          	auipc	a0,0x0
  80065e:	41e50513          	addi	a0,a0,1054 # 800a78 <error_string+0x140>
  800662:	9c5ff0ef          	jal	ra,800026 <__panic>
    assert(pid1 > 0);
  800666:	00000697          	auipc	a3,0x0
  80066a:	3ea68693          	addi	a3,a3,1002 # 800a50 <error_string+0x118>
  80066e:	00000617          	auipc	a2,0x0
  800672:	3f260613          	addi	a2,a2,1010 # 800a60 <error_string+0x128>
  800676:	02c00593          	li	a1,44
  80067a:	00000517          	auipc	a0,0x0
  80067e:	3fe50513          	addi	a0,a0,1022 # 800a78 <error_string+0x140>
  800682:	9a5ff0ef          	jal	ra,800026 <__panic>
        loop();
  800686:	f11ff0ef          	jal	ra,800596 <loop>
    }
    else {
        kill(pid1);
  80068a:	4008                	lw	a0,0(s0)
  80068c:	ac9ff0ef          	jal	ra,800154 <kill>
    }
    panic("FAIL: T.T\n");
  800690:	00000617          	auipc	a2,0x0
  800694:	42060613          	addi	a2,a2,1056 # 800ab0 <error_string+0x178>
  800698:	03900593          	li	a1,57
  80069c:	00000517          	auipc	a0,0x0
  8006a0:	3dc50513          	addi	a0,a0,988 # 800a78 <error_string+0x140>
  8006a4:	983ff0ef          	jal	ra,800026 <__panic>
        work();
  8006a8:	f01ff0ef          	jal	ra,8005a8 <work>

...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	62250513          	addi	a0,a0,1570 # 800658 <main+0xee>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	95a50513          	addi	a0,a0,-1702 # 8009b0 <error_string+0xd0>
...
exit(int error_code) {
  ...
  80013a:	54250513          	addi	a0,a0,1346 # 800678 <main+0x10e>
...
umain(void) {
  ...
  80014c:	e406                	sd	ra,8(sp)
    if (&zero != 0) {
  80014e:	00000793          	li	a5,0
  800152:	c399                	beqz	a5,800158 <umain+0xe>
        zero = -1;
  800154:	577d                	li	a4,-1
  800156:	c398                	sw	a4,0(a5)
    }
    int ret = main();
  800158:	412000ef          	jal	ra,80056a <main>
    exit(ret);
  80015c:	fd3ff0ef          	jal	ra,80012e <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019e:	4f678793          	addi	a5,a5,1270 # 800690 <main+0x126>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001fa:	4cea8a93          	addi	s5,s5,1230 # 8006c4 <main+0x15a>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800202:	6e2b8b93          	addi	s7,s7,1762 # 8008e0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800458:	26c60613          	addi	a2,a2,620 # 8006c0 <main+0x156>
  ...
  80046a:	24a60613          	addi	a2,a2,586 # 8006b0 <main+0x146>
  ...
  80047c:	23040413          	addi	s0,s0,560 # 8006a8 <main+0x13e>
  ...
  800506:	1a640413          	addi	s0,s0,422 # 8006a8 <main+0x13e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  80051c:	191a0a13          	addi	s4,s4,401 # 8006a9 <main+0x13f>
...
main(void) {
  ...
  80056e:	e822                	sd	s0,16(sp)
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800570:	bd5ff0ef          	jal	ra,800144 <fork>
  800574:	c169                	beqz	a0,800636 <main+0xcc>
  800576:	842a                	mv	s0,a0
        for (i = 0; i < 10; i ++) {
            yield();
        }
        exit(0xbeaf);
    ...
    assert(pid > 0);
  800578:	0aa05063          	blez	a0,800618 <main+0xae>
    assert(waitpid(-1, NULL) != 0);
  80057c:	4581                	li	a1,0
  80057e:	557d                	li	a0,-1
  800580:	bc7ff0ef          	jal	ra,800146 <waitpid>
  800584:	c93d                	beqz	a0,8005fa <main+0x90>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  800586:	458d                	li	a1,3
  800588:	05fa                	slli	a1,a1,0x1e
  80058a:	8522                	mv	a0,s0
  80058c:	bbbff0ef          	jal	ra,800146 <waitpid>
  800590:	c531                	beqz	a0,8005dc <main+0x72>
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  800592:	006c                	addi	a1,sp,12
  800594:	8522                	mv	a0,s0
  800596:	bb1ff0ef          	jal	ra,800146 <waitpid>
  80059a:	e115                	bnez	a0,8005be <main+0x54>
  80059c:	4732                	lw	a4,12(sp)
  80059e:	67b1                	lui	a5,0xc
  8005a0:	eaf78793          	addi	a5,a5,-337 # beaf <_start-0x7f4171>
  8005a4:	00f71d63          	bne	a4,a5,8005be <main+0x54>
    cprintf("badarg pass.\n");
  8005a8:	00000517          	auipc	a0,0x0
  8005ac:	4b850513          	addi	a0,a0,1208 # 800a60 <error_string+0x180>
  8005b0:	af3ff0ef          	jal	ra,8000a2 <cprintf>
    return 0;
}
  8005b4:	60e2                	ld	ra,24(sp)
  8005b6:	6442                	ld	s0,16(sp)
  8005b8:	4501                	li	a0,0
  8005ba:	6105                	addi	sp,sp,32
  8005bc:	8082                	ret
    assert(waitpid(pid, &exit_code) == 0 && exit_code == 0xbeaf);
  8005be:	00000697          	auipc	a3,0x0
  8005c2:	46a68693          	addi	a3,a3,1130 # 800a28 <error_string+0x148>
  8005c6:	00000617          	auipc	a2,0x0
  8005ca:	3fa60613          	addi	a2,a2,1018 # 8009c0 <error_string+0xe0>
  8005ce:	45c9                	li	a1,18
  8005d0:	00000517          	auipc	a0,0x0
  8005d4:	40850513          	addi	a0,a0,1032 # 8009d8 <error_string+0xf8>
  8005d8:	a4fff0ef          	jal	ra,800026 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  8005dc:	00000697          	auipc	a3,0x0
  8005e0:	42468693          	addi	a3,a3,1060 # 800a00 <error_string+0x120>
  8005e4:	00000617          	auipc	a2,0x0
  8005e8:	3dc60613          	addi	a2,a2,988 # 8009c0 <error_string+0xe0>
  8005ec:	45c5                	li	a1,17
  8005ee:	00000517          	auipc	a0,0x0
  8005f2:	3ea50513          	addi	a0,a0,1002 # 8009d8 <error_string+0xf8>
  8005f6:	a31ff0ef          	jal	ra,800026 <__panic>
    assert(waitpid(-1, NULL) != 0);
  8005fa:	00000697          	auipc	a3,0x0
  8005fe:	3ee68693          	addi	a3,a3,1006 # 8009e8 <error_string+0x108>
  800602:	00000617          	auipc	a2,0x0
  800606:	3be60613          	addi	a2,a2,958 # 8009c0 <error_string+0xe0>
  80060a:	45c1                	li	a1,16
  80060c:	00000517          	auipc	a0,0x0
  800610:	3cc50513          	addi	a0,a0,972 # 8009d8 <error_string+0xf8>
  800614:	a13ff0ef          	jal	ra,800026 <__panic>
    assert(pid > 0);
  800618:	00000697          	auipc	a3,0x0
  80061c:	3a068693          	addi	a3,a3,928 # 8009b8 <error_string+0xd8>
  800620:	00000617          	auipc	a2,0x0
  800624:	3a060613          	addi	a2,a2,928 # 8009c0 <error_string+0xe0>
  800628:	45bd                	li	a1,15
  80062a:	00000517          	auipc	a0,0x0
  80062e:	3ae50513          	addi	a0,a0,942 # 8009d8 <error_string+0xf8>
  800632:	9f5ff0ef          	jal	ra,800026 <__panic>
        cprintf("fork ok.\n");
  800636:	00000517          	auipc	a0,0x0
  80063a:	37250513          	addi	a0,a0,882 # 8009a8 <error_string+0xc8>
  80063e:	a65ff0ef          	jal	ra,8000a2 <cprintf>
  800642:	4429                	li	s0,10
        for (i = 0; i < 10; i ++) {
  800644:	347d                	addiw	s0,s0,-1
            yield();
  800646:	b03ff0ef          	jal	ra,800148 <yield>
        for (i = 0; i < 10; i ++) {
  80064a:	fc6d                	bnez	s0,800644 <main+0xda>
        exit(0xbeaf);
  80064c:	6531                	lui	a0,0xc
  80064e:	eaf50513          	addi	a0,a0,-337 # beaf <_start-0x7f4171>
  800652:	addff0ef          	jal	ra,80012e <exit>

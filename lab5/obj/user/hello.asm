...
exit(int error_code) {
  ...
  8000cc:	46850513          	addi	a0,a0,1128 # 800530 <main+0x38>
...
umain(void) {
  ...
  8000da:	e406                	sd	ra,8(sp)
    if (&zero != 0) {
  8000dc:	00000793          	li	a5,0
  8000e0:	c399                	beqz	a5,8000e6 <umain+0xe>
        zero = -1;
  8000e2:	577d                	li	a4,-1
  8000e4:	c398                	sw	a4,0(a5)
    }
    int ret = main();
  8000e6:	412000ef          	jal	ra,8004f8 <main>
    exit(ret);
  8000ea:	fd7ff0ef          	jal	ra,8000c0 <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80012c:	42078793          	addi	a5,a5,1056 # 800548 <main+0x50>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	3f8a8a93          	addi	s5,s5,1016 # 80057c <main+0x84>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800190:	60cb8b93          	addi	s7,s7,1548 # 800798 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e6:	19660613          	addi	a2,a2,406 # 800578 <main+0x80>
  ...
  8003f8:	17460613          	addi	a2,a2,372 # 800568 <main+0x70>
  ...
  80040a:	15a40413          	addi	s0,s0,346 # 800560 <main+0x68>
  ...
  800494:	0d040413          	addi	s0,s0,208 # 800560 <main+0x68>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004aa:	0bba0a13          	addi	s4,s4,187 # 800561 <main+0x69>
...
main(void) {
  ...
  8004fe:	36650513          	addi	a0,a0,870 # 800860 <error_string+0xc8>
main(void) {
  800502:	e406                	sd	ra,8(sp)
    cprintf("Hello world!!.\n");
  800504:	b3dff0ef          	jal	ra,800040 <cprintf>
    cprintf("I am process %d.\n", getpid());
  800508:	bcfff0ef          	jal	ra,8000d6 <getpid>
  80050c:	85aa                	mv	a1,a0
  80050e:	00000517          	auipc	a0,0x0
  800512:	36250513          	addi	a0,a0,866 # 800870 <error_string+0xd8>
  800516:	b2bff0ef          	jal	ra,800040 <cprintf>
    cprintf("hello pass.\n");
  80051a:	00000517          	auipc	a0,0x0
  80051e:	36e50513          	addi	a0,a0,878 # 800888 <error_string+0xf0>
  800522:	b1fff0ef          	jal	ra,800040 <cprintf>
    return 0;
}
  800526:	60a2                	ld	ra,8(sp)
  800528:	4501                	li	a0,0
  80052a:	0141                	addi	sp,sp,16
  80052c:	8082                	ret

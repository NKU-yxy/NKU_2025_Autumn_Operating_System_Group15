...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	5da50513          	addi	a0,a0,1498 # 800610 <main+0xa8>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5da50513          	addi	a0,a0,1498 # 800630 <main+0xc8>
...
exit(int error_code) {
  ...
  800136:	50650513          	addi	a0,a0,1286 # 800638 <main+0xd0>
...
umain(void) {
  ...
  80014a:	e406                	sd	ra,8(sp)
    if (&zero != 0) {
  80014c:	00000793          	li	a5,0
  800150:	c399                	beqz	a5,800156 <umain+0xe>
        zero = -1;
  800152:	577d                	li	a4,-1
  800154:	c398                	sw	a4,0(a5)
    }
    int ret = main();
  800156:	412000ef          	jal	ra,800568 <main>
    exit(ret);
  80015a:	fd1ff0ef          	jal	ra,80012a <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019c:	4b878793          	addi	a5,a5,1208 # 800650 <main+0xe8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f8:	490a8a93          	addi	s5,s5,1168 # 800684 <main+0x11c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800200:	6a4b8b93          	addi	s7,s7,1700 # 8008a0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800456:	22e60613          	addi	a2,a2,558 # 800680 <main+0x118>
  ...
  800468:	20c60613          	addi	a2,a2,524 # 800670 <main+0x108>
  ...
  80047a:	1f240413          	addi	s0,s0,498 # 800668 <main+0x100>
  ...
  800504:	16840413          	addi	s0,s0,360 # 800668 <main+0x100>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  80051a:	153a0a13          	addi	s4,s4,339 # 800669 <main+0x101>
...
main(void) {
  ...
  80056c:	e426                	sd	s1,8(sp)
  80056e:	ec06                	sd	ra,24(sp)
    int n, pid;
    for (n = 0; n < max_child; n ++) {
  800570:	4401                	li	s0,0
  800572:	02000493          	li	s1,32
        if ((pid = fork()) == 0) {
  800576:	bcbff0ef          	jal	ra,800140 <fork>
  80057a:	cd05                	beqz	a0,8005b2 <main+0x4a>
            cprintf("I am child %d\n", n);
            exit(0);
        }
        assert(pid > 0);
  80057c:	06a05063          	blez	a0,8005dc <main+0x74>
    for (n = 0; n < max_child; n ++) {
  800580:	2405                	addiw	s0,s0,1
  800582:	fe941ae3          	bne	s0,s1,800576 <main+0xe>
  ...
  80058e:	ed05                	bnez	a0,8005c6 <main+0x5e>
    for (; n > 0; n --) {
  800590:	347d                	addiw	s0,s0,-1
  800592:	fc65                	bnez	s0,80058a <main+0x22>
            panic("wait stopped early\n");
        }
    }

    if (wait() == 0) {
  800594:	bafff0ef          	jal	ra,800142 <wait>
  800598:	c12d                	beqz	a0,8005fa <main+0x92>
        panic("wait got too many\n");
    }

    cprintf("forktest pass.\n");
  80059a:	00000517          	auipc	a0,0x0
  80059e:	43e50513          	addi	a0,a0,1086 # 8009d8 <error_string+0x138>
  ...
  8005bc:	ae7ff0ef          	jal	ra,8000a2 <cprintf>
            exit(0);
  8005c0:	4501                	li	a0,0
  8005c2:	b69ff0ef          	jal	ra,80012a <exit>
            panic("wait stopped early\n");
  8005c6:	00000617          	auipc	a2,0x0
  8005ca:	3e260613          	addi	a2,a2,994 # 8009a8 <error_string+0x108>
  ...
  8005fe:	3c660613          	addi	a2,a2,966 # 8009c0 <error_string+0x120>

...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	55250513          	addi	a0,a0,1362 # 800588 <main+0x34>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	55250513          	addi	a0,a0,1362 # 8005a8 <main+0x54>
...
exit(int error_code) {
  ...
  80012a:	48a50513          	addi	a0,a0,1162 # 8005b0 <main+0x5c>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800188:	44478793          	addi	a5,a5,1092 # 8005c8 <main+0x74>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001e4:	41ca8a93          	addi	s5,s5,1052 # 8005fc <main+0xa8>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001ec:	630b8b93          	addi	s7,s7,1584 # 800818 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800442:	1ba60613          	addi	a2,a2,442 # 8005f8 <main+0xa4>
  ...
  800454:	19860613          	addi	a2,a2,408 # 8005e8 <main+0x94>
  ...
  800466:	17e40413          	addi	s0,s0,382 # 8005e0 <main+0x8c>
  ...
  8004f0:	0f440413          	addi	s0,s0,244 # 8005e0 <main+0x8c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800506:	0dfa0a13          	addi	s4,s4,223 # 8005e1 <main+0x8d>
...
main(void) {
  ...
  800554:	3eb00793          	li	a5,1003
  800558:	07da                	slli	a5,a5,0x16
  80055a:	438c                	lw	a1,0(a5)
main(void) {
  80055c:	1141                	addi	sp,sp,-16
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80055e:	00000517          	auipc	a0,0x0
  800562:	38250513          	addi	a0,a0,898 # 8008e0 <error_string+0xc8>
main(void) {
  800566:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800568:	b3bff0ef          	jal	ra,8000a2 <cprintf>
    panic("FAIL: T.T\n");
  80056c:	00000617          	auipc	a2,0x0
  800570:	39460613          	addi	a2,a2,916 # 800900 <error_string+0xe8>
  800574:	459d                	li	a1,7
  800576:	00000517          	auipc	a0,0x0
  80057a:	39a50513          	addi	a0,a0,922 # 800910 <error_string+0xf8>
  80057e:	aa9ff0ef          	jal	ra,800026 <__panic>
